...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'user/loginChangePassword.tpl', 20, false),array('function', 'fieldLabel', 'user/loginChangePassword.tpl', 24, false),array('modifier', 'escape', 'user/loginChangePassword.tpl', 25, false),)), $this); ?>

<?php $this->assign('pageTitle', "user.changePassword");  $this->assign('currentUrl', ($this->_tpl_vars['pageUrl'])."/login/changePassword");  $_smarty_tpl_vars = $this->_tpl_vars;
