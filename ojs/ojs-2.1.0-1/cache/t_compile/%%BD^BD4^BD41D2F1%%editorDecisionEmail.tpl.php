...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'submission/comment/editorDecisionEmail.tpl', 30, false),array('modifier', 'assign', 'submission/comment/editorDecisionEmail.tpl', 50, false),array('function', 'translate', 'submission/comment/editorDecisionEmail.tpl', 46, false),array('function', 'fieldLabel', 'submission/comment/editorDecisionEmail.tpl', 63, false),)), $this); ?>
...
<?php endif;  if ($this->_tpl_vars['isAnEditor']): ?>
	<tr valign="top">
		<td colspan="2">&nbsp;</td>
	</tr>
	<tr valign="top">
...
<input type="checkbox" name="blindCcReviewers" value="1" id="blindCcReviewers"/>&nbsp;&nbsp;<label for="blindCcReviewers"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.comments.blindCcReviewers"), $this);?>
</label>
