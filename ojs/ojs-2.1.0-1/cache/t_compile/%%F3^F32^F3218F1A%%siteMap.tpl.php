...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'about/siteMap.tpl', 19, false),array('function', 'translate', 'about/siteMap.tpl', 19, false),array('modifier', 'count', 'about/siteMap.tpl', 21, false),array('modifier', 'escape', 'about/siteMap.tpl', 23, false),array('modifier', 'assign', 'about/siteMap.tpl', 43, false),)), $this); ?>
...
?>
					<li><a href="<?php if ($this->_tpl_vars['navItem']['isAbsolute']):  echo ((is_array($_tmp=$this->_tpl_vars['navItem']['url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  else:  echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => $this->_tpl_vars['requestedPage']), $this); echo ((is_array($_tmp=$this->_tpl_vars['navItem']['url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  endif; ?>"><?php if ($this->_tpl_vars['navItem']['isLiteral']):  echo ((is_array($_tmp=$this->_tpl_vars['navItem']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  else:  echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => ((is_array($_tmp=$this->_tpl_vars['navItem']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp))), $this); endif; ?></a></li>
				<?php endforeach; endif; unset($_from); ?>
			</ul>
		</li>	
