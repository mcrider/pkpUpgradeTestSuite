...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'editor/submissionsInReview.tpl', 17, false),array('function', 'page_info', 'editor/submissionsInReview.tpl', 99, false),array('function', 'page_links', 'editor/submissionsInReview.tpl', 100, false),array('block', 'iterate', 'editor/submissionsInReview.tpl', 39, false),array('modifier', 'date_format', 'editor/submissionsInReview.tpl', 42, false),array('modifier', 'truncate', 'editor/submissionsInReview.tpl', 44, false),)), $this); ?>
		...
		<td width="30%">
			...
			<table width="100%" cols="3">
				<tr valign="top">
					...
					<td width="34%" style="padding: 0 0 0 0; font-size: 1.0em"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.done"), $this);?>
</td>
				</tr>
			</table>
		</td>
...
" class="action"><?php echo ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleTitle())) ? $this->_run_mod_handler('truncate', true, $_tmp, 40, "...") : smarty_modifier_truncate($_tmp, 40, "...")); ?>
</a></td>
		<td>
			<table width="100%" cols="3">
...
?>
				<tr valign="top">
					...
					<td width="33%" style="padding: 0 4px 0 0; font-size: 1.0em"><?php if ($this->_tpl_vars['assignment']->getDateConfirmed()):  echo ((is_array($_tmp=$this->_tpl_vars['assignment']->getDateConfirmed())) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatTrunc']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatTrunc']));  else: ?>&mdash;<?php endif; ?></td>
					<td width="34%" style="padding: 0 0 0 0; font-size: 1.0em"><?php if ($this->_tpl_vars['assignment']->getDateCompleted()):  echo ((is_array($_tmp=$this->_tpl_vars['assignment']->getDateCompleted())) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatTrunc']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatTrunc']));  else: ?>&mdash;<?php endif; ?></td>
				</tr>
				<?php endforeach; else: ?>
				<tr valign="top">
