...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'issue/current.tpl', 13, false),array('function', 'translate', 'issue/current.tpl', 18, false),array('modifier', 'assign', 'issue/current.tpl', 13, false),array('modifier', 'escape', 'issue/current.tpl', 22, false),array('modifier', 'nl2br', 'issue/current.tpl', 22, false),)), $this); ?>

<?php $this->assign('pageCrumbTitleTranslated', $this->_tpl_vars['issueCrumbTitle']);  echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'current'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'currentUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'currentUrl'));?>
