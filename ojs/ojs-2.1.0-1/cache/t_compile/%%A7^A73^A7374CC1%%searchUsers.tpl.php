...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ord', 'manager/people/searchUsers.tpl', 13, false),array('modifier', 'escape', 'manager/people/searchUsers.tpl', 27, false),array('modifier', 'chr', 'manager/people/searchUsers.tpl', 51, false),array('modifier', 'to_array', 'manager/people/searchUsers.tpl', 101, false),array('modifier', 'assign', 'manager/people/searchUsers.tpl', 101, false),array('modifier', 'truncate', 'manager/people/searchUsers.tpl', 102, false),array('function', 'url', 'manager/people/searchUsers.tpl', 18, false),array('function', 'translate', 'manager/people/searchUsers.tpl', 27, false),array('function', 'html_options_translate', 'manager/people/searchUsers.tpl', 42, false),array('function', 'icon', 'manager/people/searchUsers.tpl', 102, false),array('function', 'page_info', 'manager/people/searchUsers.tpl', 128, false),array('function', 'page_links', 'manager/people/searchUsers.tpl', 129, false),array('block', 'iterate', 'manager/people/searchUsers.tpl', 92, false),)), $this); ?>
...
?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','searchInitial' => ((is_array($_tmp=$this->_sections['letters']['index']+$this->_tpl_vars['start'])) ? $this->_run_mod_handler('chr', true, $_tmp) : chr($_tmp)),'roleId' => $this->_tpl_vars['roleId']), $this);?>
...
</strong><?php else:  echo ((is_array($_tmp=$this->_sections['letters']['index']+$this->_tpl_vars['start'])) ? $this->_run_mod_handler('chr', true, $_tmp) : chr($_tmp));  endif; ?></a> <?php endfor; endif; ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','roleId' => $this->_tpl_vars['roleId']), $this);?>
