...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/statistics/reportGenerator.tpl', 13, false),array('function', 'url', 'manager/statistics/reportGenerator.tpl', 16, false),array('function', 'html_options_translate', 'manager/statistics/reportGenerator.tpl', 20, false),array('function', 'html_select_date', 'manager/statistics/reportGenerator.tpl', 24, false),)), $this); ?>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="25%" class="label"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.statistics.reports.reportType"), $this);?>
</td>
		<td width="75%" class="value"><select name="reportType" id="reportType" class="selectMenu"><?php echo $this->_plugins['function']['html_options_translate'][0][0]->smartyHtmlOptionsTranslate(array('options' => $this->_tpl_vars['reportTypes']), $this);?>
</select></td>
	</td>
	<tr valign="top">
