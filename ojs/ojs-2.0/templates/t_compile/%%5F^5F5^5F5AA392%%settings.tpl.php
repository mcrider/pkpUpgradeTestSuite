...
smarty_core_load_plugins(array('plugins' => array(array('function', 'fieldLabel', 'admin/settings.tpl', 22, false),array('function', 'html_options', 'admin/settings.tpl', 31, false),array('function', 'translate', 'admin/settings.tpl', 35, false),array('modifier', 'escape', 'admin/settings.tpl', 23, false),)), $this); ?>
...
<table class="data" width="100%">
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'title','key' => "admin.settings.siteTitle"), $this);?>
</td>
...
" size="40" maxlength="120" class="textField" /></td>
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'contactName','key' => "admin.settings.contactName"), $this);?>
</td>
...
" size="40" maxlength="90" class="textField" /></td>
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'contactEmail','key' => "admin.settings.contactEmail"), $this);?>
</td>
...
" size="40" maxlength="90" class="textField" /></td>
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'minPasswordLength','key' => "admin.settings.minPasswordLength"), $this);?>
</td>
