...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/languageSettings.tpl', 15, false),array('function', 'url', 'manager/languageSettings.tpl', 20, false),array('function', 'fieldLabel', 'manager/languageSettings.tpl', 24, false),array('modifier', 'escape', 'manager/languageSettings.tpl', 27, false),)), $this); ?>
...
"<?php if ($this->_tpl_vars['localeKey'] == $this->_tpl_vars['primaryLocale']): ?> selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['localeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</option>
...
<tr valign="top">
	<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('suppressId' => 'true','name' => 'supportedLocales','key' => "locale.supported"), $this);?>
</td>
...
?>
		<option value="<?php echo $this->_tpl_vars['localeKey']; ?>
"<?php if ($this->_tpl_vars['localeKey'] == $this->_tpl_vars['alternateLocale1']): ?> selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['localeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</option>
	<?php endforeach; endif; unset($_from); ?>
	</select></td>
</tr>
...
?>
		<option value="<?php echo $this->_tpl_vars['localeKey']; ?>
"<?php if ($this->_tpl_vars['localeKey'] == $this->_tpl_vars['alternateLocale2']): ?> selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['localeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</option>
	<?php endforeach; endif; unset($_from); ?>
	</select></td>
</tr>
