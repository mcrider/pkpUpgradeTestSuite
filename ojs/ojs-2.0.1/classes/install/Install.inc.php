 ...
 *
 * $Id: Install.inc.php,v 1.1 2005/06/27 03:54:15 kevin Exp $
 */
...
class Install extends Installer {
	...
	function createData() {
		if ($this->getParam('manualInstall')) {
			...
			$this->executeSQL(sprintf('INSERT INTO users (username, password, email) VALUES (\'%s\', \'%s\', \'%s\')', $this->getParam('adminUsername'), Validation::encryptCredentials($this->getParam('adminUsername'), $this->getParam('adminPassword'), $this->getParam('encryption')), $this->getParam('adminEmail')));
