...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'comment/comments.tpl', 14, false),array('modifier', 'truncate', 'comment/comments.tpl', 14, false),array('modifier', 'date_format', 'comment/comments.tpl', 24, false),array('modifier', 'nl2br', 'comment/comments.tpl', 49, false),array('function', 'translate', 'comment/comments.tpl', 24, false),array('function', 'assign_translate', 'comment/comments.tpl', 34, false),array('function', 'mailto', 'comment/comments.tpl', 35, false),)), $this); ?>
...
&nbsp;&nbsp;
	...
	<?php if ($this->_tpl_vars['enableComments'] == 'unauthenticated' || ( ( $this->_tpl_vars['enableComments'] == 'authenticated' || $this->_tpl_vars['enableComments'] == 'anonymous' ) && $this->_tpl_vars['isUserLoggedIn'] )): ?>
...
')" <?php endif; ?>class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "comments.delete"), $this);?>
	...
	<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['comment']->getBody())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
<?php if ($this->_tpl_vars['child']->getPosterEmail()): ?>
	...
	<?php echo smarty_function_mailto(array('text' => $this->_tpl_vars['emailReply'],'encode' => 'javascript','address' => $this->_tpl_vars['child']->getPosterEmail(),'subject' => $this->_tpl_vars['child']->getTitle(),'extra' => 'class="action"'), $this);?>
&nbsp;&nbsp;
<?php endif; ?>
...
<p><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['child']->getBody())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 300, "... ".($this->_tpl_vars['moreLink'])) : smarty_modifier_truncate($_tmp, 300, "... ".($this->_tpl_vars['moreLink']))); ?>
</p>
