...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'user/changePassword.tpl', 13, false),array('function', 'translate', 'user/changePassword.tpl', 20, false),array('function', 'fieldLabel', 'user/changePassword.tpl', 24, false),array('modifier', 'assign', 'user/changePassword.tpl', 13, false),array('modifier', 'escape', 'user/changePassword.tpl', 25, false),)), $this); ?>

<?php $this->assign('pageTitle', "user.changePassword");  echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => 'changePassword'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'currentUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'currentUrl'));?>
...
<tr valign="top">
	...
	<td width="80%" class="value"><input type="password" name="oldPassword" id="oldPassword" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['oldPassword'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
