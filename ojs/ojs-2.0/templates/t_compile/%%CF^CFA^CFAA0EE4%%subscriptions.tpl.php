...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/subscription/subscriptions.tpl', 17, false),array('function', 'page_info', 'manager/subscription/subscriptions.tpl', 59, false),array('function', 'page_links', 'manager/subscription/subscriptions.tpl', 60, false),array('block', 'iterate', 'manager/subscription/subscriptions.tpl', 38, false),array('modifier', 'date_format', 'manager/subscription/subscriptions.tpl', 42, false),array('modifier', 'escape', 'manager/subscription/subscriptions.tpl', 44, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'subscriptions','item' => 'subscription')); $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true);while ($_block_repeat) { ob_start(); ?>
	<tr valign="top">
		<td><?php echo $this->_tpl_vars['subscription']->getUserFullName(); ?>
</td>
		<td><?php echo $this->_tpl_vars['subscription']->getTypeName(); ?>
</td>
...
/manager/createSubscription" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.subscriptions.create"), $this);?>
</a>
