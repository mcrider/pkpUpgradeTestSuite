...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'user/register.tpl', 17, false),array('function', 'fieldLabel', 'user/register.tpl', 37, false),array('modifier', 'escape', 'user/register.tpl', 38, false),array('modifier', 'nl2br', 'user/register.tpl', 137, false),)), $this); ?>
...
<?php if (! $this->_tpl_vars['existingUser']): ?>
	<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.alreadyRegisteredOtherJournal",'registerUrl' => ($this->_tpl_vars['pageUrl'])."/user/register?existingUser=1"), $this);?>
</p>
<?php else: ?>
	<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.notAlreadyRegisteredOtherJournal",'registerUrl' => ($this->_tpl_vars['pageUrl'])."/user/register"), $this);?>
</p>
...
<tr valign="top">
	<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'registerAs','key' => "user.register.registerAs"), $this);?>
</td>
...
</label>: <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.reviewerDescription"), $this);?>
 <input type="text" name="interests" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['fax'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="20" maxlength="255" class="textField" /><?php endif; ?></td>
</tr>
</table>
