...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'copyeditor/submission/layout.tpl', 15, false),array('function', 'icon', 'copyeditor/submission/layout.tpl', 66, false),array('modifier', 'date_format', 'copyeditor/submission/layout.tpl', 33, false),)), $this); ?>
...
:
&nbsp; <?php if ($this->_tpl_vars['layoutAssignment']->getEditorId()):  echo $this->_tpl_vars['layoutAssignment']->getEditorFullName();  else:  echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.none"), $this); endif; ?>
</p>
<?php endif; ?>
