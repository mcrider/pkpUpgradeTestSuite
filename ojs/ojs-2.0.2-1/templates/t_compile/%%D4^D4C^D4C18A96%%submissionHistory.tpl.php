...
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign_translate', 'sectionEditor/submissionHistory.tpl', 13, false),array('function', 'translate', 'sectionEditor/submissionHistory.tpl', 49, false),array('function', 'icon', 'sectionEditor/submissionHistory.tpl', 87, false),array('block', 'iterate', 'sectionEditor/submissionHistory.tpl', 77, false),array('modifier', 'date_format', 'sectionEditor/submissionHistory.tpl', 79, false),array('modifier', 'escape', 'sectionEditor/submissionHistory.tpl', 81, false),array('modifier', 'strip_unsafe_html', 'sectionEditor/submissionHistory.tpl', 92, false),array('modifier', 'truncate', 'sectionEditor/submissionHistory.tpl', 92, false),array('modifier', 'nl2br', 'sectionEditor/submissionHistory.tpl', 176, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'eventLogEntries','item' => 'logEntry')); $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true);while ($_block_repeat) { ob_start(); ?>
	<tr valign="top">
		...
		<td><?php echo ((is_array($_tmp=$this->_tpl_vars['logEntry']->getAssocTypeString())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
		<td>
 ...
 <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => ($this->_tpl_vars['pageUrl'])."/user/email?to[]=".($this->_tpl_vars['emailStringEscaped'])."&amp;redirectUrl=".($this->_tpl_vars['urlEscaped'])."&amp;subject=".($this->_tpl_vars['subjectEscaped'])), $this);?>
		...
		<td>
			...
			<br />
			<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['logEntry']->getMessage())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : $this->_plugins['modifier']['strip_unsafe_html'][0][0]->smartyStripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : smarty_modifier_truncate($_tmp, 60, "...")); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'emailLogEntries','item' => 'logEntry')); $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true);while ($_block_repeat) { ob_start(); ?>
	<tr valign="top">
		...
		<td><strong><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['logEntry']->getSubject())) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : smarty_modifier_truncate($_tmp, 60, "...")))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</strong></td>
...
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['note']->getNote())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : $this->_plugins['modifier']['strip_unsafe_html'][0][0]->smartyStripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</div></td>
