...
<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.installationInstructions",'version' => $this->_tpl_vars['version']->getVersionString(),'baseUrl' => $this->_tpl_vars['baseUrl'],'pageUrl' => $this->_tpl_vars['pageUrl']), $this);?>
