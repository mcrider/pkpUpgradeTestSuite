...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'editor/issues/issueData.tpl', 17, false),array('function', 'translate', 'editor/issues/issueData.tpl', 17, false),array('function', 'html_options', 'editor/issues/issueData.tpl', 25, false),array('function', 'fieldLabel', 'editor/issues/issueData.tpl', 44, false),array('function', 'html_select_date', 'editor/issues/issueData.tpl', 103, false),array('modifier', 'escape', 'editor/issues/issueData.tpl', 37, false),array('modifier', 'date_format', 'editor/issues/issueData.tpl', 78, false),array('modifier', 'to_array', 'editor/issues/issueData.tpl', 132, false),)), $this); ?>
...
<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editIssue','path' => $this->_tpl_vars['issueId']), $this);?>
...
<?php if (( $this->_tpl_vars['enableSubscriptions'] && ! $this->_tpl_vars['enableDelayedOpenAccess'] ) || ( $this->_tpl_vars['enableSubscriptions'] && $this->_tpl_vars['enableDelayedOpenAccess'] && $this->_tpl_vars['issue']->getPublished() )): ?>
<div class="separator"></div>
...
</a>&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'removeCoverPage','path' => $this->_tpl_vars['issueId']), $this);?>
...
');" class="file"><?php echo $this->_tpl_vars['originalStyleFileName']; ?>
</a>&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'removeStyleFile','path' => $this->_tpl_vars['issueId']), $this);?>
" onclick="return confirm('<?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.issues.removeStyleFile"), $this))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript'));?>
')"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.issues.remove"), $this);?>
</a><?php else: ?>&mdash;<?php endif; ?></td>
	</tr>
	<tr valign="top">
...
" onclick="document.location.href='<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'issueManagement','path' => ((is_array($_tmp='issueData')) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['issueId']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['issueId'])),'escape' => false), $this);?>
'" class="button" /></p>
