<?php /* Smarty version 2.6.26, created on 2010-08-12 16:18:38
...
<table width="100%" class="listing" id="adminJournals">
	...
	<tr valign="top" id="journal-<?php echo $this->_tpl_vars['journal']->getJournalID(); ?>
" class="data">
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['journal']->getLocalizedTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
		...
		<td><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'moveJournal','d' => 'u','id' => $this->_tpl_vars['journal']->getJournalId()), $this);?>
">&uarr;</a> <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'moveJournal','d' => 'd','id' => $this->_tpl_vars['journal']->getJournalId()), $this);?>
">&darr;</a></td>
