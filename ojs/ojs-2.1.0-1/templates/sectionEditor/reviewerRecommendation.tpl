 ...
 *
 * $Id: reviewerRecommendation.tpl,v 1.10 2005/12/18 19:28:55 alec Exp $
 *}
...
<p><input type="submit" value="{translate key="common.save"}" class="button defaultButton" /> <input type="button" value="{translate key="common.cancel"}" class="button" onclick="document.location.href='{url op="submissionsInReview" path=$articleId escape=false}';"/></p>
</form>
