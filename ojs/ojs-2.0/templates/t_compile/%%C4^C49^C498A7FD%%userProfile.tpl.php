...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'manager/people/userProfile.tpl', 15, false),array('modifier', 'default', 'manager/people/userProfile.tpl', 28, false),array('modifier', 'nl2br', 'manager/people/userProfile.tpl', 70, false),array('modifier', 'date_format', 'manager/people/userProfile.tpl', 87, false),array('function', 'translate', 'manager/people/userProfile.tpl', 17, false),array('function', 'icon', 'manager/people/userProfile.tpl', 53, false),)), $this); ?>
...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['user']->getBiography())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
</td>
	</tr>
...
if ($this->_foreach['workingLanguages']['total'] > 0):
 ...
 echo $this->_tpl_vars['localeNames'][$this->_tpl_vars['localeKey']];  if (! ($this->_foreach['workingLanguages']['iteration'] == $this->_foreach['workingLanguages']['total'])): ?>; <?php endif;  endforeach; else: ?>&mdash;<?php endif; unset($_from); ?></td>
	</tr>
	<?php endif; ?>
	<tr valign="top">
...
/manager/unEnroll/<?php echo $this->_tpl_vars['userRoles'][$this->_sections['role']['index']]->getRoleId(); ?>
