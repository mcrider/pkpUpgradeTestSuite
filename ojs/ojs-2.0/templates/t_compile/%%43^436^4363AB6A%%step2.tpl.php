...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/setup/step2.tpl', 18, false),array('function', 'fieldLabel', 'manager/setup/step2.tpl', 268, false),array('modifier', 'escape', 'manager/setup/step2.tpl', 21, false),)), $this); ?>
...
:<br/>
		<input type="checkbox" name="remindForInvite" id="remindForInvite" value="1" onclick="toggleAllowSetInviteReminder(this.form)"<?php if ($this->_tpl_vars['remindForInvite']): ?> checked="checked"<?php endif; ?> />&nbsp;
...
"<?php if ($this->_tpl_vars['numDaysBeforeInviteReminder'] == $this->_sections['inviteDayOptions']['index'] || ( $this->_sections['inviteDayOptions']['index'] == 5 && ! $this->_tpl_vars['remindForInvite'] )): ?> selected="SELECTED"<?php endif; ?>><?php echo $this->_sections['inviteDayOptions']['index']; ?>
		...
		<input type="checkbox" name="remindForSubmit" id="remindForSubmit" value="1" onclick="toggleAllowSetSubmitReminder(this.form)"<?php if ($this->_tpl_vars['remindForSubmit']): ?> checked="checked"<?php endif; ?> />&nbsp;
...
<br/>
		<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.note"), $this);?>
: <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.reviewOptions.noteOnEmailWording"), $this);?>
...
<h3>2.5 <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.securitySettings"), $this);?>
</h3>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="5%" class="label"><input type="radio" name="enableComments" id="enableComments[0]" value="disabled"<?php if ($this->_tpl_vars['enableComments'] == 'disabled' || $this->_tpl_vars['enableComments'] == ''): ?> checked="checked"<?php endif; ?> /></td>
		<td width="95%" class="value"><label for="enableComments[0]"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.comments.disable"), $this);?>
</label></td>
	</tr>
	<tr valign="top">
		<td width="5%" class="label"><input type="radio" name="enableComments" id="enableComments[1]" value="authenticated"<?php if ($this->_tpl_vars['enableComments'] == 'authenticated'): ?> checked="checked"<?php endif; ?> /></td>
		<td width="95%" class="value"><label for="enableComments[1]"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.comments.authenticated"), $this);?>
</label></td>
	</tr>
	<tr valign="top">
		<td width="5%" class="label"><input type="radio" name="enableComments" id="enableComments[2]" value="anonymous"<?php if ($this->_tpl_vars['enableComments'] == 'anonymous'): ?> checked="checked"<?php endif; ?> /></td>
		<td width="95%" class="value"><label for="enableComments[2]"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.comments.anonymous"), $this);?>
</label></td>
	</tr>
	<tr valign="top">
		<td width="5%" class="label"><input type="radio" name="enableComments" id="enableComments[3]" value="unauthenticated"<?php if ($this->_tpl_vars['enableComments'] == 'unauthenticated'): ?> checked="checked"<?php endif; ?> /></td>
		<td width="95%" class="value"><label for="enableComments[3]"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.comments.unauthenticated"), $this);?>
</label></td>
	</tr>
</table>
...
<h3>2.6 <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.addItemtoAboutJournal"), $this);?>
</h3>
