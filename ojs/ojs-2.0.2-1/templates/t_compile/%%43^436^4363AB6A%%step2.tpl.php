...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/setup/step2.tpl', 18, false),array('function', 'fieldLabel', 'manager/setup/step2.tpl', 163, false),array('modifier', 'escape', 'manager/setup/step2.tpl', 21, false),)), $this); ?>
...
<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.lockssRegister",'pageUrl' => $this->_tpl_vars['pageUrl']), $this);?>
</p>

<p><input type="checkbox" name="enableLockss" id="enableLockss" value="1"<?php if ($this->_tpl_vars['enableLockss']): ?> checked="checked"<?php endif; ?> /> <label for="enableLockss"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.lockssEnable",'pageUrl' => $this->_tpl_vars['pageUrl']), $this);?>
</label></p>
