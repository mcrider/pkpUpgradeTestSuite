...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'about/submissions.tpl', 16, false),array('modifier', 'nl2br', 'about/submissions.tpl', 36, false),)), $this); ?>
...
<p>
	<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.onlineSubmissions.haveAccount",'journalTitle' => $this->_tpl_vars['siteTitle']), $this);?>
<br />
...
<a name="privacyStatement"></a><h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.privacyStatement"), $this);?>
</h3>
