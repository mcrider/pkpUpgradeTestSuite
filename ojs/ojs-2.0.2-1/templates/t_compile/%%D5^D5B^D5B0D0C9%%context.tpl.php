...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'rt/context.tpl', 63, false),array('modifier', 'trim', 'rt/context.tpl', 91, false),array('function', 'translate', 'rt/context.tpl', 67, false),)), $this); ?>
...
" value="<?php if ($this->_tpl_vars['postParam']['needsKeywords']): ?>KEYWORDS_HERE<?php else:  echo ((is_array($_tmp=$this->_tpl_vars['postParam']['value'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  endif; ?>" />
	<?php endforeach; endif; unset($_from); ?>
	<tr valign="top">
		<td width="10%">
