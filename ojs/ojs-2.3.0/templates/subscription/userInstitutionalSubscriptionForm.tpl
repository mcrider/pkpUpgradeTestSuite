 ...
 *
 * $Id: userInstitutionalSubscriptionForm.tpl,v 1.1 2009/06/02 20:20:03 michael Exp $
 *}
{strip}
...
{if $subscriptionId}
<form method="post" action="{url op="payPurchaseSubscription" path="institutional"|to_array:$subscriptionId}">
{else}
<form method="post" action="{url op="payPurchaseSubscription" path="institutional"}">
{/if}
