...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'help/searchResults.tpl', 16, false),array('function', 'get_help_id', 'help/searchResults.tpl', 21, false),array('function', 'url', 'help/searchResults.tpl', 35, false),array('function', 'eval', 'help/searchResults.tpl', 36, false),array('modifier', 'escape', 'help/searchResults.tpl', 27, false),array('modifier', 'count', 'help/searchResults.tpl', 30, false),array('modifier', 'explode', 'help/searchResults.tpl', 35, false),array('modifier', 'strip_tags', 'help/searchResults.tpl', 36, false),array('modifier', 'truncate', 'help/searchResults.tpl', 36, false),array('modifier', 'to_array', 'help/searchResults.tpl', 38, false),)), $this); ?>
...
?>
				...
				<li>
					<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'view','path' => ((is_array($_tmp=$this->_tpl_vars['result']['topic']->getId())) ? $this->_run_mod_handler('explode', true, $_tmp, "/") : $this->_plugins['modifier']['explode'][0][0]->smartyExplode($_tmp, "/"))), $this);?>
"><?php echo $this->_tpl_vars['result']['topic']->getTitle(); ?>
</a>
					<?php echo smarty_function_eval(array('var' => ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['sections'][0]->getContent())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 200) : smarty_modifier_truncate($_tmp, 200))), $this);?>
