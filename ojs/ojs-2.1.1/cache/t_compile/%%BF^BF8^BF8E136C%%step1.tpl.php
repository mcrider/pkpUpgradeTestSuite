...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submit/step1.tpl', 15, false),array('function', 'url', 'author/submit/step1.tpl', 45, false),array('function', 'fieldLabel', 'author/submit/step1.tpl', 102, false),array('function', 'html_options', 'author/submit/step1.tpl', 103, false),array('modifier', 'escape', 'author/submit/step1.tpl', 31, false),array('modifier', 'nl2br', 'author/submit/step1.tpl', 65, false),array('modifier', 'assign', 'author/submit/step1.tpl', 96, false),)), $this); ?>
...
'<?php echo ');
				...
				alert('; ?>
'<?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.copyrightNoticeAgreeRequired"), $this))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript'));?>
'<?php echo ');
				return false;
			}
		}
