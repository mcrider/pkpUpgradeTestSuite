...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'submission/metadata/metadataEdit.tpl', 15, false),array('function', 'translate', 'submission/metadata/metadataEdit.tpl', 35, false),array('function', 'fieldLabel', 'submission/metadata/metadataEdit.tpl', 51, false),array('modifier', 'escape', 'submission/metadata/metadataEdit.tpl', 37, false),)), $this); ?>
...
" size="30" maxlength="90" class="textField" /></td>
	...
	<tr valign="top">
		...
		<td class="value"><input type="text" name="authors[<?php echo $this->_tpl_vars['authorIndex']; ?>
][url]" id="authors-<?php echo $this->_tpl_vars['authorIndex']; ?>
-url" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['author']['url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="30" maxlength="90" class="textField" /></td>
	</tr>
	<tr valign="top">
...
" size="40" maxlength="255" class="textField" />
			...
			<br />
			<span class="instruct"><?php echo ((is_array($_tmp=$this->_tpl_vars['journalSettings']['metaDisciplineExamples'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span>
			<?php endif; ?>
		</td>
	</tr>
...
" size="40" maxlength="255" class="textField" />
			...
			<br />
			<span class="instruct"><?php echo ((is_array($_tmp=$this->_tpl_vars['journalSettings']['metaSubjectExamples'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span>
			<?php endif; ?>
		</td>
	</tr>
...
" size="40" maxlength="255" class="textField" />
			...
			<br />
			<span class="instruct"><?php echo ((is_array($_tmp=$this->_tpl_vars['journalSettings']['metaCoverageGeoExamples'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span>
			<?php endif; ?>
		</td>
	</tr>
...
" size="40" maxlength="255" class="textField" />
			...
			<br />
			<span class="instruct"><?php echo ((is_array($_tmp=$this->_tpl_vars['journalSettings']['metaCoverageChronExamples'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span>
			<?php endif; ?>
		</td>
	</tr>
...
" size="40" maxlength="255" class="textField" />
			...
			<br />
			<span class="instruct"><?php echo ((is_array($_tmp=$this->_tpl_vars['journalSettings']['metaCoverageResearchSampleExamples'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span>
			<?php endif; ?>
		</td>
	</tr>
