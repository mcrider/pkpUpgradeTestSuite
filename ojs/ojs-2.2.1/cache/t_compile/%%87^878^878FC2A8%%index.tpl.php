...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'about/index.tpl', 14, false),array('function', 'url', 'about/index.tpl', 17, false),array('function', 'call_hook', 'about/index.tpl', 23, false),array('block', 'iterate', 'about/index.tpl', 20, false),array('modifier', 'escape', 'about/index.tpl', 21, false),)), $this); ?>
<?php $this->assign('pageTitle', "about.aboutTheJournal"); ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.editorialTeam"), $this);?>
	...
	<?php $this->_tag_stack[] = array('iterate', array('from' => 'peopleGroups','item' => 'peopleGroup')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'displayMembership','path' => $this->_tpl_vars['peopleGroup']->getGroupId()), $this);?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['peopleGroup']->getGroupTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</a></li>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.archiving"), $this);?>
	...
	<?php if ($this->_tpl_vars['journalSettings']['journalPaymentsEnabled'] && $this->_tpl_vars['journalSettings']['membershipFeeEnabled'] && $this->_tpl_vars['journalSettings']['membershipFee'] > 0): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'memberships'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.memberships"), $this);?>
</a></li><?php endif; ?>
	<?php if (! empty ( $this->_tpl_vars['journalSettings']['enableSubscriptions'] )): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'subscriptions'), $this);?>
