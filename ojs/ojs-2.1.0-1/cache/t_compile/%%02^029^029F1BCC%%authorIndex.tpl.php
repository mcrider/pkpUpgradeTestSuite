...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ord', 'search/authorIndex.tpl', 12, false),array('modifier', 'chr', 'search/authorIndex.tpl', 17, false),array('modifier', 'escape', 'search/authorIndex.tpl', 25, false),array('function', 'url', 'search/authorIndex.tpl', 17, false),array('function', 'translate', 'search/authorIndex.tpl', 17, false),array('function', 'page_info', 'search/authorIndex.tpl', 37, false),array('function', 'page_links', 'search/authorIndex.tpl', 37, false),array('block', 'iterate', 'search/authorIndex.tpl', 19, false),)), $this); ?>
...
?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'authors','searchInitial' => ((is_array($_tmp=$this->_sections['letters']['index']+$this->_tpl_vars['start'])) ? $this->_run_mod_handler('chr', true, $_tmp) : chr($_tmp))), $this);?>
...
</strong><?php else:  echo ((is_array($_tmp=$this->_sections['letters']['index']+$this->_tpl_vars['start'])) ? $this->_run_mod_handler('chr', true, $_tmp) : chr($_tmp));  endif; ?></a> <?php endfor; endif; ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'authors'), $this);?>
