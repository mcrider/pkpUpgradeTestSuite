...
<br /><br />
<a href="http://www.pkp.ubc.ca/harvester/add.php" target="_blank">Click here</a> and enter <span class="highlight">{$siteUrl}</span> under <b>Site URL</b>, and <span class="highlight">{$oaiUrl}</span> under <b>Base URL for OAI Archive</b>.
<br /><br />
...
<span class="formError">Warning: Modifying these settings can potentially leave your site in an inaccessible state (requiring your configuration file to be manually fixed). It is strongly recommended that you do not make any changes unless you know exactly what you are doing.</span>',
  ...
  'admin.systemConfigFileReadError' => 'The configuration file <tt>config.inc.php</tt> does not exist or is not readable.',
...
<p>The system could not automatically overwrite the configuration file. To apply your configuration changes you must open <tt>config.inc.php</tt> in a suitable text editor and replace its contents with the contents of the text field below.</p>',
  ...
  'manager.setup.details.description' => 'Name of journal, ISBN, contacts, sponsors, and search engines.',
  ...
  'manager.setup.subjectClassificationDescription' => 'Journal will use a subject classification system available on the web.',
...
Select a model for handling these aspects of the editorial process. (To designate a Managing Editor and Section Editors, go to Editors in Journal Management.)',
  ...
  'manager.setup.enablePageNumber' => 'Page numbers for each published item will be included in the Table of Contents of this journal (e.g., 
pp. 13-26).',
  ...
  'manager.people.importUsers' => 'Import Users',
  'manager.people.importUsers.failedToImportUser' => 'Failed to import user',
  'manager.people.importUsers.failedToImportRole' => 'Failed to assign user to role',
  'manager.people.importUsers.dataFile' => 'User data file',
  'manager.people.importUsers.sendNotify' => 'Send a notification email to each imported user containing the user\'s username and password.',
  'manager.people.importUsers.continueOnError' => 'Continue to import other users if a failure occurs.',
  'manager.people.importUsers.importInstructions' => 'Select an XML data file containing user information to import into this journal. See the journal help for details on the format of this file.<br /><br />Note that if the imported file contains any usernames or email addresses that already exist in the system, the user data for those users will not be imported and any new roles to be created will be assigned to the existing users.',
  'manager.people.importUsers.noFileError' => 'No file was uploaded!',
  'manager.people.importUsers.usersWereImported' => 'The following users were successfully imported into the system',
  'manager.people.importUsers.errorsOccurred' => 'Errors occurred during the import',
  'manager.people.importUsers.confirmUsers' => 'Confirm that these are the users you would like to import into the system',
...
current password.<br /><br />Enter your email address below to reset your password. A confirmation will be sent to this email address.',
  ...
  'search.basicSearch' => 'Basic Search',
  ...
  'about.other' => 'Other',
  'about.aboutOJSJournal' => 'This journal uses Open Journal Systems, which is open source journal management and publishing software developed, supported, and freely distributed by the <a href="http://www.pkp.ubc.ca/">Public Knowledge Project</a> under the GNU General Public License.',
  'about.aboutOJSSite' => 'This site uses Open Journal Systems, which is open source journal management and publishing software developed, supported, and freely distributed by the <a href="http://www.pkp.ubc.ca/">Public Knowledge Project</a> under the GNU General Public License.',
  'help.help' => 'Help',
...
Validation may fail on search URLs that require posted form data.',
  ...
  'default.journalSettings.checklist.addressesLinked' => 'All URL addresses in the text (e.g., <a href="http://pkp.ubc.ca">http://pkp.ubc.ca</a>) are activated and ready to click.',
