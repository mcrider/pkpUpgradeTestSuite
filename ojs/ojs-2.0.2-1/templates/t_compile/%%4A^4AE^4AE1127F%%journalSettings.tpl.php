...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'admin/journalSettings.tpl', 25, false),array('function', 'fieldLabel', 'admin/journalSettings.tpl', 30, false),array('modifier', 'escape', 'admin/journalSettings.tpl', 31, false),)), $this); ?>
...
" size="16" maxlength="32" class="textField" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "admin.journals.urlWillBe",'path' => ($this->_tpl_vars['indexUrl'])), $this);?>
</span>
		</td>
	</tr>
	<tr valign="top">
