...
<?php $this->assign('pageTitle', "editor.issues.createIssue");  $this->assign('currentUrl', ($this->_tpl_vars['pageUrl'])."/editor/createIssue");  $_smarty_tpl_vars = $this->_tpl_vars;
...
/editor/saveIssue" enctype="multipart/form-data">
