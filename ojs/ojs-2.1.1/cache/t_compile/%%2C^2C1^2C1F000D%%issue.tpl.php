...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'issue/issue.tpl', 13, false),array('modifier', 'strip_unsafe_html', 'issue/issue.tpl', 18, false),array('modifier', 'to_array', 'issue/issue.tpl', 36, false),array('function', 'url', 'issue/issue.tpl', 32, false),array('function', 'translate', 'issue/issue.tpl', 32, false),)), $this); ?>
...
<tr valign="top">
	...
	<td align="right" width="25%">
		<?php if ($this->_tpl_vars['section']['abstractsDisabled'] || $this->_tpl_vars['article']->getAbstract() == ""): ?>
			<?php $this->assign('abstractLabel', "article.details"); ?>
		<?php else: ?>
			<?php $this->assign('abstractLabel', "article.abstract"); ?>
		<?php endif; ?>
		...
		<?php if (! $this->_tpl_vars['hasAccess'] || $this->_tpl_vars['article']->getAbstract() != ""): ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => $this->_tpl_vars['article']->getBestArticleId($this->_tpl_vars['currentJournal'])), $this);?>
" class="file"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => $this->_tpl_vars['abstractLabel']), $this);?>
</a><?php endif; ?>
