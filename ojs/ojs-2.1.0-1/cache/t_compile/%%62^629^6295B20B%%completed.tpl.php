<?php /* Smarty version 2.6.12, created on 2006-02-03 13:26:39
         compiled from proofreader/completed.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'proofreader/completed.tpl', 20, false),array('function', 'html_options_translate', 'proofreader/completed.tpl', 22, false),array('function', 'translate', 'proofreader/completed.tpl', 25, false),array('function', 'html_select_date', 'proofreader/completed.tpl', 34, false),array('function', 'print_issue_id', 'proofreader/completed.tpl', 74, false),array('function', 'page_info', 'proofreader/completed.tpl', 93, false),array('function', 'page_links', 'proofreader/completed.tpl', 94, false),array('modifier', 'escape', 'proofreader/completed.tpl', 28, false),array('modifier', 'date_format', 'proofreader/completed.tpl', 60, false),array('modifier', 'truncate', 'proofreader/completed.tpl', 62, false),array('modifier', 'strip_unsafe_html', 'proofreader/completed.tpl', 63, false),array('block', 'iterate', 'proofreader/completed.tpl', 54, false),)), $this); ?>
...
" class="action"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getArticleTitle())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : smarty_modifier_truncate($_tmp, 60, "...")); ?>
		...
		<td><?php echo ((is_array($_tmp=$this->_tpl_vars['proofAssignment']->getDateProofreaderCompleted())) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatTrunc']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatTrunc'])); ?>
</td>
		<td align="right">
