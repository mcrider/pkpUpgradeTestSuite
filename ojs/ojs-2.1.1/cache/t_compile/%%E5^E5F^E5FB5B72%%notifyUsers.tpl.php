...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'editor/notifyUsers.tpl', 20, false),array('modifier', 'assign', 'editor/notifyUsers.tpl', 33, false),array('function', 'translate', 'editor/notifyUsers.tpl', 29, false),array('function', 'fieldLabel', 'editor/notifyUsers.tpl', 99, false),array('block', 'iterate', 'editor/notifyUsers.tpl', 83, false),)), $this); ?>
...
<tr valign="top">
	...
	<td width="75%" class="label">
		<label for="interestedUsers"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.notifyUsers.interestedUsers",'count' => $this->_tpl_vars['notifiableCount']), $this);?>
</label>
	</td>
</tr>
<tr valign="top">
	...
	<td width="95%" class="label">
		<label for="allUsers"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.notifyUsers.allUsers",'count' => $this->_tpl_vars['allUsersCount']), $this);?>
</label>
	</td>
</tr>
<?php if ($this->_tpl_vars['senderEmail']): ?>
	<tr valign="top">
		...
		<td width="95%" class="label">
			<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "email.bccSender",'address' => ((is_array($_tmp=$this->_tpl_vars['senderEmail'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp))), $this);?>
