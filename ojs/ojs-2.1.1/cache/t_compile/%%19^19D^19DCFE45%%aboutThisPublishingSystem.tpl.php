...
<p>
<?php if ($this->_tpl_vars['currentJournal']):  echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.aboutOJSJournal",'ojsVersion' => $this->_tpl_vars['ojsVersion']), $this);?>

<?php else:  echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.aboutOJSSite",'ojsVersion' => $this->_tpl_vars['ojsVersion']), $this);?>
