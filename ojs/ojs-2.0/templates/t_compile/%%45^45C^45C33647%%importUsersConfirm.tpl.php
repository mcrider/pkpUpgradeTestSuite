<?php /* Smarty version 2.6.9, created on 2005-05-17 03:44:50
         compiled from manager/people/importUsersConfirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/people/importUsersConfirm.tpl', 15, false),array('modifier', 'escape', 'manager/people/importUsersConfirm.tpl', 44, false),)), $this); ?>
...
<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.people.importUsers.confirmUsers"), $this);?>
:
<form action="<?php echo $this->_tpl_vars['pageUrl']; ?>
/manager/importUsers/import" method="post">
<?php if ($this->_tpl_vars['sendNotify']): ?>
	<input type="hidden" name="sendNotify" value="<?php echo $this->_tpl_vars['sendNotify']; ?>
" />
<?php endif;  if ($this->_tpl_vars['continueOnError']): ?>
	<input type="hidden" name="continueOnError" value="<?php echo $this->_tpl_vars['continueOnError']; ?>
" />
<?php endif; ?>
...
<input type="submit" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.people.importUsers"), $this);?>
