<?php /* Smarty version 2.6.12, created on 2006-02-03 13:26:45
         compiled from subscription/subscriptions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'subscription/subscriptions.tpl', 17, false),array('function', 'translate', 'subscription/subscriptions.tpl', 17, false),array('function', 'page_info', 'subscription/subscriptions.tpl', 58, false),array('function', 'page_links', 'subscription/subscriptions.tpl', 59, false),array('block', 'iterate', 'subscription/subscriptions.tpl', 37, false),array('modifier', 'escape', 'subscription/subscriptions.tpl', 39, false),array('modifier', 'date_format', 'subscription/subscriptions.tpl', 41, false),)), $this); ?>
...
<ul class="menu">
	<li class="current"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'subscriptions'), $this);?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'subscriptions','item' => 'subscription')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<tr valign="top">
		...
		<td><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editSubscription','path' => $this->_tpl_vars['subscription']->getSubscriptionId()), $this);?>
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.edit"), $this);?>
</a>&nbsp;|&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'deleteSubscription','path' => $this->_tpl_vars['subscription']->getSubscriptionId()), $this);?>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack);  if ($this->_tpl_vars['subscriptions']->wasEmpty()): ?>
	<tr>
...
<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectSubscriber'), $this);?>
