...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submission/editors.tpl', 15, false),array('function', 'url', 'sectionEditor/submission/editors.tpl', 17, false),array('function', 'icon', 'sectionEditor/submission/editors.tpl', 40, false),array('modifier', 'to_array', 'sectionEditor/submission/editors.tpl', 39, false),array('modifier', 'strip_tags', 'sectionEditor/submission/editors.tpl', 39, false),array('modifier', 'assign', 'sectionEditor/submission/editors.tpl', 39, false),array('modifier', 'escape', 'sectionEditor/submission/editors.tpl', 40, false),array('modifier', 'date_format', 'sectionEditor/submission/editors.tpl', 68, false),)), $this); ?>
...
<table width="100%" class="listing">
	<tr><td colspan="<?php if ($this->_tpl_vars['isEditor']): ?>6<?php else: ?>5<?php endif; ?>" class="headseparator">&nbsp;</td></tr>
	<tr class="heading" valign="bottom">
		<td width="<?php if ($this->_tpl_vars['isEditor']): ?>20%<?php else: ?>25%<?php endif; ?>">&nbsp;</td>
		<td width="30%">&nbsp;</td>
		<td align="center" width="10%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.review"), $this);?>
</td>
		<td align="center" width="10%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.editing"), $this);?>
</td>
...
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.delete"), $this);?>
		...
		<tr><td colspan="<?php if ($this->_tpl_vars['isEditor']): ?>6<?php else: ?>5<?php endif; ?>" class="<?php if (($this->_foreach['editAssignments']['iteration'] == $this->_foreach['editAssignments']['total'])): ?>end<?php endif; ?>separator">&nbsp;</td></tr>
	<?php endforeach; else: ?>
		...
		<tr><td colspan="<?php if ($this->_tpl_vars['isEditor']): ?>6<?php else: ?>5<?php endif; ?>" class="endseparator">&nbsp;</td></tr>
