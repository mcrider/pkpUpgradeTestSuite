...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'rt/email.tpl', 19, false),array('function', 'translate', 'rt/email.tpl', 28, false),array('function', 'assign_translate', 'rt/email.tpl', 32, false),array('function', 'fieldLabel', 'rt/email.tpl', 44, false),)), $this); ?>
...
<tr valign="top">
	...
	<td class="value"><textarea name="body" cols="50" rows="15" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['body'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></td>
</tr>
</table>
