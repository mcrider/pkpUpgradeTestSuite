...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'copyeditor/submission/copyedit.tpl', 13, false),array('function', 'url', 'copyeditor/submission/copyedit.tpl', 24, false),array('function', 'icon', 'copyeditor/submission/copyedit.tpl', 36, false),array('modifier', 'escape', 'copyeditor/submission/copyedit.tpl', 18, false),array('modifier', 'date_format', 'copyeditor/submission/copyedit.tpl', 32, false),array('modifier', 'default', 'copyeditor/submission/copyedit.tpl', 32, false),array('modifier', 'assign', 'copyeditor/submission/copyedit.tpl', 38, false),array('modifier', 'to_array', 'copyeditor/submission/copyedit.tpl', 49, false),)), $this); ?>
...
<table width="100%" class="data">
	<tr>
		...
		<td class="value" width="80%"><?php if ($this->_tpl_vars['submission']->getCopyeditorId()):  echo ((is_array($_tmp=$this->_tpl_vars['copyeditor']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  else:  echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.none"), $this); endif; ?></td>
	</tr>
</table>
