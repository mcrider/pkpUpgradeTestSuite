...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'proofreader/submission/proofread.tpl', 13, false),array('function', 'icon', 'proofreader/submission/proofread.tpl', 39, false),array('modifier', 'date_format', 'proofreader/submission/proofread.tpl', 28, false),array('modifier', 'default', 'proofreader/submission/proofread.tpl', 28, false),)), $this); ?>
...
:
&nbsp; <?php echo $this->_tpl_vars['proofAssignment']->getProofreaderFullName(); ?>
</p>
	...
	<tr>
		...
		<td>
			<?php if (! $this->_tpl_vars['proofAssignment']->getDateProofreaderNotified() || ! $this->_tpl_vars['useProofreaders'] || $this->_tpl_vars['proofAssignment']->getDateProofreaderCompleted()): ?>
				<?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','disabled' => 'disabled','url' => ($this->_tpl_vars['requestPageUrl'])."/completeProofreader?articleId=".($this->_tpl_vars['submission']->getArticleId())), $this);?>

			<?php else: ?>
				<?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => ($this->_tpl_vars['requestPageUrl'])."/completeProofreader?articleId=".($this->_tpl_vars['submission']->getArticleId())), $this);?>
