...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'about/editorialPolicies.tpl', 20, false),array('modifier', 'escape', 'about/editorialPolicies.tpl', 28, false),array('modifier', 'nl2br', 'about/editorialPolicies.tpl', 35, false),)), $this); ?>
...
/about/editorialPolicies#openAccessPolicy"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.openAccessPolicy"), $this);?>
	...
	<?php if ($this->_tpl_vars['journalSettings']['enableLockss'] && ! empty ( $this->_tpl_vars['journalSettings']['lockssLicense'] )): ?><li>&#187; <a href="<?php echo $this->_tpl_vars['pageUrl']; ?>
/about/editorialPolicies#archiving"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.archiving"), $this);?>
</a></li><?php endif; ?>
...
?>
 ...
 <?php echo ((is_array($_tmp=$this->_tpl_vars['sectionEditor']->getLastName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  if (strlen ( $this->_tpl_vars['sectionEditor']->getAffiliation() ) > 0): ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['sectionEditor']->getAffiliation())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  endif; ?></li>
		...
		<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.sections.Indexed"), $this);?>
</p>
	</form>
<?php endforeach; endif; unset($_from); ?>
