<?php return array (
  ...
  'user.email' => 'Email',
  'user.url' => 'URL',
  'user.url.description' => 'This will appear as a hyperlinked URL at the bottom of the bio statement on the "About the author" pop-up and "Editorial team" page.',
  'user.phone' => 'Phone',
  'user.fax' => 'Fax',
...
Note that the OAI interface can be disabled for this site by editing the OJS system configuration. Future versions of OJS will allow the OAI interface to be enabled or disabled for individual journals within the site.',
  ...
  'admin.auth.defaultSourceDescription' => 'Specifying a default authentication source other than OJS has the following effects:
<ul>
...
<p>The system could not automatically overwrite the configuration file. To apply your configuration changes you must open <tt>config.inc.php</tt> in a suitable text editor and replace its contents with the contents of the text field below.</p>',
  ...
  'manager.setup.management.description' => 'Scheduling, online access, announcements, and use of copyeditors, layout editors and proofreaders.',
  ...
  'manager.setup.doiPrefixDescription' => 'The DOI (Digital Object Identifier) Prefix is assigned by <a href="http://www.crossref.org">CrossRef</a> and is in the format 10.xxxx (e.g. 10.1234).',
  ...
  'manager.setup.restrictSiteAccess' => 'Users must log in to view the journal site.',
  ...
  'manager.setup.restrictArticleAccess' => 'Users must log in to view the full text of published articles.',
...
Setting up LOCKSS support for Open Journal Systems does not need to take place until after publishing is fully underway, at which point follow these two steps:',
  ...
  'manager.setup.authorCopyrightNoticeDescription' => 'This Copyright Notice will appear in About the Journal and in each published item\'s metadata. Authors can retain copyright, while granting the journal right of first publication. Alternatively, authors can transfer copyright to the journal, which then permits authors non-commercial use of the work, 
including the right to place it in an open access archive. In addition, <a href="http://www.creativecommons.org" target="_blank">Creative Commons</a> can be consulted for flexible copyright licenses.',
...
Select a model for handling these aspects of the editorial process. (To designate a Managing Editor and Section Editors, go to Editors in Journal Management.)',
  ...
  'manager.setup.onlineAccessManagement' => 'Online Access Management',
  ...
  'manager.setup.openAccessPolicyDescription' => 'Enter a statement on the journal\'s open access policy that will appear in About the Journal.',
  'manager.setup.subscription' => 'The journal will require subscriptions to access some or all of its contents.',
  'manager.setup.subscriptionDescription' => 'The Subscription Management module requires that a Subscription Manager be assigned who has access to the module, which includes additional open access, self-archiving, and email notification options.',
  ...
  'manager.sections.identifyType' => 'For metadata purposes, identify every item in this section as a',
  ...
  'manager.groups.create' => 'Create Editorial Team Title',
  'manager.groups.form.groupTitleRequired' => 'A group title is required.',
  'manager.groups.enableBoard.description' => 'For the <a href="{$aboutEditorialTeamUrl}">Editorial Team</a> in About the Journal:',
  'manager.groups.enableBoard' => 'The Journal Manager will create editorial team titles, and add the appropriate people under each title.',
  'manager.groups.disableBoard' => 'The system will generate a list of people under their assigned editorial roles (Journal Manager, Editor, Section Editor, Copyeditor, etc.)',
...
You may optionally provide the user with a reason for disabling their account.',
  ...
  'manager.people.enrollUserAsDescription' => 'If no roles are selected, the user will be created in the system but not be enrolled in any role within this journal. Roles can be assigned or unassigned at any point after the user is created.',
  ...
  'manager.people.signOutAsUser' => 'Log Out as User',
  ...
  'manager.subscriptionPolicies.openAccessOptionsDescription' => 'Subscription journals can provide "delayed open access" and/or "author self-archiving" (which increase readership and citation of content). The selected policies will appear in About the Journal.',
  ...
  'manager.subscriptionPolicies.delayedOpenAccessPolicyDescription' => 'The following statement will be posted in About the Journal under Delayed Open Access.',
  ...
  'manager.subscriptionPolicies.authorSelfArchiveDescription' => 'The following policy will be included in About the Journal.',
  ...
  'manager.subscriptionTypes.form.public' => 'This subscription type will not appear under Subscriptions in About the Journal.',
  ...
  'editor.submissionReview.notes' => 'Due indicates number of weeks remaining until the review\'s due date or (-) weeks that it is overdue. It is filled in when a reviewer accepts the request to review.',
...
Active is how many reviews are currently being considered or underway.',
  ...
  'sectionEditor.review.enrollReviewer' => 'Enroll Existing User As Reviewer',
  ...
  'author.submit.startHereLink' => 'Click here to start the submission process',
...
The file can be viewed by clicking on the file name. A new or revised file can be uploaded, deleting the one that currently appears. Additional files can be added using Supplementary Files (next step). If you have difficulties uploading the submission, contact <a href="mailto:{$supportEmail}">{$supportName}</a> by email or phone {$supportPhone} for assistance.',
...
<p>If you haven\'t already registered and wish to receive news and updates, <strong>please register at <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> If you have questions or comments, please visit the <a href="http://pkp.sfu.ca/support/forum" target="_new">support forum</a>.</p>',
  ...
  'rt.admin.settings.printerFriendly' => 'Print version (Leads to a printer-friendly version of an item).',
  ...
  'rt.admin.settings.addComment' => 'Add comment (enables readers to post comments, which Journal Managers can delete. Reader Comments must be enabled in Setup, step 2).',
...
Validation may fail on search URLs that require posted form data.',
  ...
  'default.journalSettings.checklist.addressesLinked' => 'When available, the URLs to access references online are provided, including those for open access versions of the reference. The URLs are ready to click (e.g., <a href="http://pkp.sfu.ca">http://pkp.sfu.ca</a>).',
  ...
  'default.journalSettings.authorSelfArchivePolicy' => 'Authors are permitted and encouraged to post items submitted to this journal on personal or institutional websites, prior to and after publication (while providing the bibliographic details of that publication).',
