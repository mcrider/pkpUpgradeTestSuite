...
smarty_core_load_plugins(array('plugins' => array(array('function', 'fieldLabel', 'manager/subscription/subscriptionForm.tpl', 33, false),array('function', 'translate', 'manager/subscription/subscriptionForm.tpl', 35, false),array('function', 'html_select_date', 'manager/subscription/subscriptionForm.tpl', 49, false),array('modifier', 'escape', 'manager/subscription/subscriptionForm.tpl', 35, false),array('block', 'iterate', 'manager/subscription/subscriptionForm.tpl', 42, false),)), $this); ?>
...
/selectSubscriber<?php if ($this->_tpl_vars['subscriptionId']): ?>?subscriptionId=<?php echo $this->_tpl_vars['subscriptionId'];  endif; ?>" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.select"), $this);?>
</a>
