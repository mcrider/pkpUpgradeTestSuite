...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'search/searchResults.tpl', 20, false),array('function', 'page_info', 'search/searchResults.tpl', 105, false),array('function', 'page_links', 'search/searchResults.tpl', 106, false),array('modifier', 'escape', 'search/searchResults.tpl', 20, false),array('block', 'iterate', 'search/searchResults.tpl', 75, false),)), $this); ?>
...
"><?php endif;  echo $this->_tpl_vars['issue']->getIssueIdentification();  if ($this->_tpl_vars['issue']->getAccessStatus()): ?></a><?php endif; ?></td>
	<td width="30%"><?php echo $this->_tpl_vars['article']->getArticleTitle(); ?>
</td>
...
</a><?php if (( $this->_tpl_vars['issue']->getAccessStatus() || $this->_tpl_vars['issueAvailable'] )):  $_from = $this->_tpl_vars['publishedArticle']->getGalleys(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['galleyList'] = array('total' => count($_from), 'iteration' => 0);
