...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'manager/people/userProfile.tpl', 15, false),array('modifier', 'default', 'manager/people/userProfile.tpl', 28, false),array('modifier', 'to_array', 'manager/people/userProfile.tpl', 51, false),array('modifier', 'assign', 'manager/people/userProfile.tpl', 51, false),array('modifier', 'strip_unsafe_html', 'manager/people/userProfile.tpl', 73, false),array('modifier', 'nl2br', 'manager/people/userProfile.tpl', 73, false),array('modifier', 'date_format', 'manager/people/userProfile.tpl', 94, false),array('function', 'translate', 'manager/people/userProfile.tpl', 17, false),array('function', 'url', 'manager/people/userProfile.tpl', 19, false),array('function', 'icon', 'manager/people/userProfile.tpl', 52, false),)), $this); ?>
...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value"><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getUrl())) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getUrl())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a></td>
	</tr>
	<tr valign="top">
