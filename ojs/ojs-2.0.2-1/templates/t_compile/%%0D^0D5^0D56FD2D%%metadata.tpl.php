...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submission/metadata.tpl', 13, false),array('function', 'icon', 'author/submission/metadata.tpl', 29, false),array('modifier', 'escape', 'author/submission/metadata.tpl', 26, false),array('modifier', 'default', 'author/submission/metadata.tpl', 33, false),array('modifier', 'nl2br', 'author/submission/metadata.tpl', 37, false),array('modifier', 'strip_unsafe_html', 'author/submission/metadata.tpl', 82, false),)), $this); ?>
...
<br />(<?php echo ((is_array($_tmp=$this->_tpl_vars['languageToggleLocales'][$this->_tpl_vars['alternateLocale1']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
		...
		<td class="value"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getAbstractAlt1())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : $this->_plugins['modifier']['strip_unsafe_html'][0][0]->smartyStripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
</td>
	</tr>
	<?php endif; ?>
	<?php if ($this->_tpl_vars['alternateLocale2']): ?>
...
<br />(<?php echo ((is_array($_tmp=$this->_tpl_vars['languageToggleLocales'][$this->_tpl_vars['alternateLocale2']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
		...
		<td class="value"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getAbstractAlt2())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : $this->_plugins['modifier']['strip_unsafe_html'][0][0]->smartyStripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
</td>
	</tr>
	<?php endif; ?>
	<?php endif; ?>
