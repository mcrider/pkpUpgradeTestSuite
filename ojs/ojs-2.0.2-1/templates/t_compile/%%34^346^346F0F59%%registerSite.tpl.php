...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'user/registerSite.tpl', 13, false),array('block', 'iterate', 'user/registerSite.tpl', 16, false),array('modifier', 'escape', 'user/registerSite.tpl', 17, false),)), $this); ?>
...
/user/register"><?php echo ((is_array($_tmp=$this->_tpl_vars['journal']->getTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a></li>
