...
<p>The system could not automatically overwrite the configuration file. To apply your configuration changes you must open <tt>config.inc.php</tt> in a suitable text editor and replace its contents with the contents of the text field below.</p>',
  ...
  'manager.statistics.statistics' => 'Statistics',
  ...
  'manager.statistics.statistics.forSection' => 'Journal Section {$sectionTitle}:',
  'manager.statistics.statistics.count.accept' => 'Accept (%):',
  'manager.statistics.statistics.count.decline' => 'Decline (%):',
  'manager.statistics.statistics.count.revise' => 'Revise (%):',
  'manager.statistics.statistics.count.undecided' => 'Undecided (%):',
  ...
  'manager.statistics.statistics.daysPerReview' => 'Days Taken:',
  ...
  'manager.statistics.statistics.countryDistribution' => 'Country Distribution:',
  ...
  'manager.statistics.reports.includeInReportType' => 'Include the following in',
  ...
  'manager.statistics.reports.csvNote' => '<strong>Note:</strong> Reports are generated in CSV format and should be viewed using a spreadsheet application.',
  ...
  'manager.plugins.sitePlugin' => 'This is a site-wide plugin. Only the Site Manager may manage this plugin.',
...
You may optionally provide the user with a reason for disabling their account.',
  ...
  'editor.issues.invalidStyleFormat' => 'Invalid stylesheet format. Ensure that the submitted file is a valid CSS.',
...
Active is how many reviews are currently being considered or underway.',
  ...
  'editor.article.cannotRecord' => 'Before a decision can be recorded, a submission must be assigned to a Section Editor. The Review Version becomes, by default, the Editor Version.',
  ...
  'author.submit.copyrightNoticeAgreeRequired' => 'You must agreee to the terms of the Copyright Notice before continuing.',
...
The file can be viewed by clicking on the file name. A new or revised file can be uploaded, deleting the one that currently appears. If you have difficulties uploading the submission, contact <a href="mailto:{$supportEmail}">{$supportName}</a> by email or phone {$supportPhone} for assistance.',
  ...
  'author.submit.expedite' => 'If this submission is in a format that is ready to be published, without further review, editing, or layout work, it can be sent directly to the Schedule Submissions queue by <a href="{$expediteUrl}" class="action">Clicking here</a>. (Note: Only journal editors have this option for their submissions.)',
...
<p>If you haven\'t already registered and wish to receive news and updates, <strong>please register at <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> If you have questions or comments, please visit the <a href="http://pkp.sfu.ca/support/forum" target="_new">support forum</a>.</p>',
  ...
  'rt.admin.settings.bibFormat' => 'Bibliographic format for citation capture',
  'rt.admin.settings.captureCite' => 'Bibliographic info (Displays the citation of an article in standard format, with support for the following citation management software: EndNote, Reference Manager, and ProCite)',
  'rt.admin.settings.viewMetadata' => 'Indexing info (Displays an item\'s indexing information generated by the author and the system)',
  ...
  'rt.admin.settings.defineTerms' => 'Definition of terms (Enables readers to double-click on any word in an item and send the word to a dictionary)',
...
Validation may fail on search URLs that require posted form data.',
  ...
  'rt.suppFiles.viewMetadata' => 'Indexing info',
  'rt.suppFiles.download' => 'Download',
  'rt.captureCite' => 'Bibliographic info',
