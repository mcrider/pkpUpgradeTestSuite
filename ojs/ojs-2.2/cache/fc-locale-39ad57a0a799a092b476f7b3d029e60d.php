...
<p>The system could not automatically overwrite the configuration file. To apply your configuration changes you must open <tt>config.inc.php</tt> in a suitable text editor and replace its contents with the contents of the text field below.</p>',
  ...
  'manager.statistics.reports.dateFrom' => 'From',
  'manager.statistics.reports.dateTo' => 'Until',
  'manager.statistics.reports.reportType' => 'Type of report',
  'manager.statistics.reports.type.journal' => 'Journal Report',
  'manager.statistics.reports.type.editor' => 'Editor Report',
  'manager.statistics.reports.type.reviewer' => 'Reviewer Report',
  'manager.statistics.reports.type.section' => 'Section Report',
  'manager.statistics.reports.generate' => 'Generate Report',
  'manager.statistics.reports.status' => 'Status (Accepted, declined, other)',
  'manager.statistics.reports.dateDecided' => 'Date Decided',
  'manager.statistics.reports.author' => 'Author #{$num}',
  'manager.statistics.reports.affiliation' => 'Affiliation #{$num}',
  'manager.statistics.reports.country' => 'Country #{$num}',
  'manager.statistics.reports.reviewer' => 'Reviewer #{$num}',
  'manager.statistics.reports.editor' => 'Editor #{$num}',
  'manager.statistics.reports.score' => 'Score #{$num}',
  'manager.statistics.reports.singleScore' => 'Score',
  'manager.statistics.reports.recommendation' => 'Recommendation #{$num}',
  'manager.statistics.reports.daysToDecision' => 'Days To Decision',
  'manager.statistics.reports.daysToPublication' => 'Days To Publication',
  ...
  'manager.payment.options.payPerViewFee' => 'Article Pay-Per-View',
  ...
  'manager.payment.form.numeric' => 'All costs must be positve numeric values (decimal points are allowed)',
  ...
  'manager.setup.enableUserRegistration.reader' => 'Readers (will recieve notifications and be counted as equivalent to a subscriber)',
...
Select a model for handling these aspects of the editorial process. (To designate a Managing Editor and Section Editors, go to Editors in Journal Management.)',
  ...
  'manager.setup.referenceLinkingDescription' => '<p>To enable readers to locate online versions of the work cited by an author, the following options are avaiable.</p>
...
<ol>
  ...
  'manager.sections.identifyType' => 'For metadata purposes, identify every item in this section as a(n)',
  'manager.sections.identifyTypeExamples' => '(For example, "Peer-reviewed Article", "Non-refereed Article", "Invited Article", etc.)',
  'manager.sections.abstractsDisabled' => 'Do not require abstracts',
...
<li>By default only articles containing <i>all</i> terms in the query are returned (i.e., <i>AND</i> is implied)</li>
<li>Combine multiple words with <i>OR</i> to find articles containing either term; e.g., <i>education OR research</i></li>
...
<li>Exclude a word by prefixing it with <b>-</b> or <i>NOT</i>; e.g. <i>online -politics</i> or <i>online NOT politics</i></li>
<li>Use <b>*</b> in a term as a wildcard to match any sequence of characters; e.g., <i>soci* morality</i> would match documents containing "sociological" or "societal"</li>
  ...
  'payment.loginRequired.forArticle' => 'Subscription or pay-per-view required to access item. To verify subscription or to pay fee, log in to journal.',
  ...
  'payment.type.payPerView' => 'Article Pay-Per-View Fee',
...
<p>If you haven\'t already registered and wish to receive news and updates, <strong>please register at <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> If you have questions or comments, please visit the <a href="http://pkp.sfu.ca/support/forum" target="_new">support forum</a>.</p>',
  ...
  'rt.admin.rtEnable' => 'To enable Reading Tools for this journal, go to Reading Tool Options.',
...
Validation may fail on search URLs that require posted form data.',
  ...
  'icon.small.alt' => 'Small',
  'icon.medium.alt' => 'Medium',
  'icon.large.alt' => 'Large',
...
{$indexUrl}/{$journalPath}',
  ...
  'default.journalSettings.payPerViewFeeDescription' => 'The payment of this fee will enable you to view, download, and print this article.',
