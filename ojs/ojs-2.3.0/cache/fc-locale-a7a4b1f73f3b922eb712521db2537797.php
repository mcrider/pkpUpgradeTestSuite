<?php return array (
  ...
  'plugins.generic.staticPages.viewInstructions' => 'Pages can then be accessed at: {$pagesPath}/%PATH%, where %PATH% is a value you choose. <strong>Note:</strong> No two pages can have the same path.',
