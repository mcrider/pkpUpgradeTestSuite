...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/sections/sections.tpl', 20, false),array('function', 'url', 'manager/sections/sections.tpl', 32, false),array('function', 'page_info', 'manager/sections/sections.tpl', 48, false),array('function', 'page_links', 'manager/sections/sections.tpl', 49, false),array('block', 'iterate', 'manager/sections/sections.tpl', 27, false),array('modifier', 'escape', 'manager/sections/sections.tpl', 29, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'sections','item' => 'section','name' => 'sections')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<tr valign="top">
		<td><?php echo ((is_array($_tmp=$this->_tpl_vars['section']->getSectionTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
		<td><?php echo ((is_array($_tmp=$this->_tpl_vars['section']->getSectionAbbrev())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
		<td align="right" class="nowrap">
			<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editSection','path' => $this->_tpl_vars['section']->getSectionId()), $this);?>
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.edit"), $this);?>
</a>&nbsp;|&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'deleteSection','path' => $this->_tpl_vars['section']->getSectionId()), $this);?>
...
</a>&nbsp;|&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'moveSection','d' => 'u','sectionId' => $this->_tpl_vars['section']->getSectionId()), $this);?>
">&uarr;</a>&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'moveSection','d' => 'd','sectionId' => $this->_tpl_vars['section']->getSectionId()), $this);?>
">&darr;</a>
		</td>
	</tr>
	<tr>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack);  if ($this->_tpl_vars['sections']->wasEmpty()): ?>
	<tr>
