...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/files/index.tpl', 15, false),array('function', 'icon', 'manager/files/index.tpl', 44, false),array('modifier', 'escape', 'manager/files/index.tpl', 15, false),array('modifier', 'default', 'manager/files/index.tpl', 46, false),array('modifier', 'date_format', 'manager/files/index.tpl', 47, false),)), $this); ?>

<?php $this->assign('pageTitle', "manager.filesBrowser");  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "common/header.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  $this->assign('displayDir', "/".($this->_tpl_vars['currentDir'])); ?>
<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.files.indexOfDir",'dir' => ((is_array($_tmp=$this->_tpl_vars['displayDir'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp))), $this);?>
</h3>
...
?>
	...
	<?php endif; ?>
	<?php $this->assign('filePath', ((is_array($_tmp=$this->_tpl_vars['filePath'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp))); ?>
	<tr valign="top">
...
"><?php echo $this->_tpl_vars['file']['name']; ?>
		...
		<td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['file']['mimetype'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
</td>
		<td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['file']['mtime'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['datetimeFormatShort']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['datetimeFormatShort'])); ?>
</td>
		<td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['file']['size'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
</td>
...
/manager/fileUpload/<?php echo ((is_array($_tmp=$this->_tpl_vars['currentDir'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
...
<form method="post" action="<?php echo $this->_tpl_vars['pageUrl']; ?>
/manager/fileMakeDir/<?php echo ((is_array($_tmp=$this->_tpl_vars['currentDir'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
" enctype="multipart/form-data">
