<?php return array (
  ...
  'editor.article.confirmChangeReviewForm' => 'Changing the review form will remove responses...',
...
<ol>
  ...
  'manager.section.sectionEditorInstructions' => 'Add a Section Editor to this section from the available Section Editors. Once added, designate whether the Section Editor will oversee the REVIEW (peer review) and/or the EDITING (copyediting, layout and proofreading) of submissions to this section. Section Editors are created by clicking <a href="{$sectionEditorsUrl}">Section Editors</a> under Roles in Journal Management.',
