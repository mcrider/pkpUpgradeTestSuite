...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'about/editorialTeam.tpl', 17, false),array('function', 'url', 'about/editorialTeam.tpl', 23, false),array('modifier', 'escape', 'about/editorialTeam.tpl', 23, false),)), $this); ?>
...
</a><?php if ($this->_tpl_vars['editor']->getAffiliation()): ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['editor']->getAffiliation())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  endif;  if ($this->_tpl_vars['editor']->getCountry()):  $this->assign('countryCode', $this->_tpl_vars['editor']->getCountry());  $this->assign('country', $this->_tpl_vars['countries'][$this->_tpl_vars['countryCode']]); ?>, <?php echo $this->_tpl_vars['country'];  endif; ?>
	<br/>
...
')"><?php echo ((is_array($_tmp=$this->_tpl_vars['sectionEditor']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a><?php if ($this->_tpl_vars['sectionEditor']->getAffiliation()): ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['sectionEditor']->getAffiliation())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  endif;  if ($this->_tpl_vars['sectionEditor']->getCountry()):  $this->assign('countryCode', $this->_tpl_vars['sectionEditor']->getCountry());  $this->assign('country', $this->_tpl_vars['countries'][$this->_tpl_vars['countryCode']]); ?>, <?php echo $this->_tpl_vars['country'];  endif; ?>
	<br/>
<?php endforeach; endif; unset($_from);  endif; ?>
...
')"><?php echo ((is_array($_tmp=$this->_tpl_vars['layoutEditor']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a><?php if ($this->_tpl_vars['layoutEditor']->getAffiliation()): ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['layoutEditor']->getAffiliation())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  endif;  if ($this->_tpl_vars['layoutEditor']->getCountry()):  $this->assign('countryCode', $this->_tpl_vars['layoutEditor']->getCountry());  $this->assign('country', $this->_tpl_vars['countries'][$this->_tpl_vars['countryCode']]); ?>, <?php echo $this->_tpl_vars['country'];  endif; ?>
	<br/>
<?php endforeach; endif; unset($_from);  endif; ?>
...
')"><?php echo ((is_array($_tmp=$this->_tpl_vars['copyEditor']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a><?php if ($this->_tpl_vars['copyEditor']->getAffiliation()): ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['copyEditor']->getAffiliation())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  endif;  if ($this->_tpl_vars['copyEditor']->getCountry()):  $this->assign('countryCode', $this->_tpl_vars['copyEditor']->getCountry());  $this->assign('country', $this->_tpl_vars['countries'][$this->_tpl_vars['countryCode']]); ?>, <?php echo $this->_tpl_vars['country'];  endif; ?>
	<br/>
<?php endforeach; endif; unset($_from);  endif; ?>
...
')"><?php echo ((is_array($_tmp=$this->_tpl_vars['proofreader']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a><?php if ($this->_tpl_vars['proofreader']->getAffiliation()): ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['proofreader']->getAffiliation())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  endif;  if ($this->_tpl_vars['proofreader']->getCountry()):  $this->assign('countryCode', $this->_tpl_vars['proofreader']->getCountry());  $this->assign('country', $this->_tpl_vars['countries'][$this->_tpl_vars['countryCode']]); ?>, <?php echo $this->_tpl_vars['country'];  endif; ?>
	<br/>
<?php endforeach; endif; unset($_from);  endif; ?>
