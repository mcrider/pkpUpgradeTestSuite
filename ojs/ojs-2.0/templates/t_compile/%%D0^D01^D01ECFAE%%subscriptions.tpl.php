...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'about/subscriptions.tpl', 15, false),array('function', 'mailto', 'about/subscriptions.tpl', 30, false),array('modifier', 'nl2br', 'about/subscriptions.tpl', 21, false),array('modifier', 'string_format', 'about/subscriptions.tpl', 58, false),array('block', 'iterate', 'about/subscriptions.tpl', 52, false),)), $this); ?>
...
<p>
	<?php if (! empty ( $this->_tpl_vars['subscriptionName'] )): ?>
		<strong><?php echo $this->_tpl_vars['subscriptionName']; ?>
</strong><br />
	<?php endif; ?>
...
: <?php echo $this->_tpl_vars['subscriptionPhone']; ?>
<br />
	<?php endif; ?>
...
: <?php echo $this->_tpl_vars['subscriptionFax']; ?>
<br />
	<?php endif; ?>
...
: <?php echo smarty_function_mailto(array('address' => $this->_tpl_vars['subscriptionEmail'],'encode' => 'hex'), $this);?>
<br /><br />
	<?php endif; ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'subscriptionTypes','item' => 'subscriptionType')); $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true);while ($_block_repeat) { ob_start(); ?>
	<?php if ($this->_tpl_vars['subscriptionType']->getPublic()): ?>
		<tr valign="top">
			...
			<td><?php echo $this->_tpl_vars['subscriptionType']->getDurationYearsMonths(); ?>
</td>
