...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submission/rounds.tpl', 13, false),array('function', 'icon', 'sectionEditor/submission/rounds.tpl', 133, false),array('modifier', 'date_format', 'sectionEditor/submission/rounds.tpl', 26, false),array('modifier', 'ord', 'sectionEditor/submission/rounds.tpl', 70, false),array('modifier', 'chr', 'sectionEditor/submission/rounds.tpl', 76, false),array('modifier', 'count', 'sectionEditor/submission/rounds.tpl', 205, false),)), $this); ?>

<a name="rounds"></a>
<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "sectionEditor.regrets.regretsAndCancels"), $this);?>
</h3>
...
<table width="100%" class="listing">
	<tr valign="top">
		...
		<td class="heading" width="15%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.request"), $this);?>
</td>
		<td class="heading" width="15%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "sectionEditor.regrets.result"), $this);?>
</td>
	</tr>
<?php $_from = $this->_tpl_vars['cancelsAndRegrets']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['cancelOrRegret']):
?>
	<tr valign="top">
		<td><?php echo $this->_tpl_vars['cancelOrRegret']->getReviewerFullName(); ?>
</td>
		<td>
...
<h4><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.reviewer"), $this);?>
 ...
 <?php echo $this->_tpl_vars['reviewAssignment']->getReviewerFullName(); ?>
</h4>
...
?>
 ...
 <?php echo ((is_array($_tmp=$this->_tpl_vars['editorDecision']['dateDecided'])) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatShort']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatShort'])); ?>
	...
	<tr valign="top">
		<td class="label" width="20%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.editorAuthorComments"), $this);?>
</td>
		<td class="value" width="80%">
...
" class="label"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.editorVersion"), $this);?>
			...
			<td width="30%"><a href="<?php echo $this->_tpl_vars['requestPageUrl']; ?>
/downloadFile/<?php echo $this->_tpl_vars['submission']->getArticleId(); ?>
