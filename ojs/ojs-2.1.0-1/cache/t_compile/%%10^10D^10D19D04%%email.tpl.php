...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'manager/people/email.tpl', 38, false),array('modifier', 'assign', 'manager/people/email.tpl', 51, false),array('function', 'translate', 'manager/people/email.tpl', 47, false),array('function', 'fieldLabel', 'manager/people/email.tpl', 62, false),array('function', 'url', 'manager/people/email.tpl', 145, false),)), $this); ?>
...
<tr valign="top">
	<td>&nbsp;</td>
	<td class="value">
		<input type="submit" onclick="document.submit.action='<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectTemplate'), $this);?>
';" class="button" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.people.emailUsers.selectTemplate"), $this);?>
"/>
	</td>
</tr>
<tr valign="top">
