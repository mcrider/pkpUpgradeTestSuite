...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'article/interstitial.tpl', 20, false),array('function', 'translate', 'article/interstitial.tpl', 24, false),)), $this); ?>
...
/download/<?php echo $this->_tpl_vars['escapedArticleId']; ?>
...
<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "article.nonpdf.note",'pdfUrl' => ($this->_tpl_vars['requestPageUrl'])."/download/".($this->_tpl_vars['escapedArticleId'])."/".($this->_tpl_vars['galley']->getGalleyId())), $this);?>
</p>
