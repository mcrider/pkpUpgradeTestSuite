...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'article/interstitial.tpl', 22, false),array('function', 'url', 'article/interstitial.tpl', 28, false),array('modifier', 'to_array', 'article/interstitial.tpl', 28, false),array('modifier', 'assign', 'article/interstitial.tpl', 38, false),)), $this); ?>
...
" type="text/css" />
	...
	<meta http-equiv="refresh" content="2;URL=<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'download','path' => ((is_array($_tmp=$this->_tpl_vars['articleId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['galley']->getGalleyId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['galley']->getGalleyId()))), $this);?>
"/>
...
<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "article.nonpdf.note",'url' => $this->_tpl_vars['url']), $this);?>
</p>
