...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'submission/suppFile/suppFile.tpl', 21, false),array('function', 'translate', 'submission/suppFile/suppFile.tpl', 25, false),array('function', 'fieldLabel', 'submission/suppFile/suppFile.tpl', 30, false),array('function', 'html_options_translate', 'submission/suppFile/suppFile.tpl', 53, false),array('modifier', 'escape', 'submission/suppFile/suppFile.tpl', 31, false),array('modifier', 'to_array', 'submission/suppFile/suppFile.tpl', 113, false),array('modifier', 'date_format', 'submission/suppFile/suppFile.tpl', 125, false),)), $this); ?>
...
<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => $this->_tpl_vars['rolePath'],'op' => 'saveSuppFile','path' => $this->_tpl_vars['suppFileId']), $this);?>
...
" size="60" maxlength="255" class="textField" /></td>
	...
	<tr valign="top">
		...
		<td width="80%" class="value"><input type="text" id="publicSuppFileId" name="publicSuppFileId" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['publicSuppFileId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
" size="60" maxlength="255" class="textField" /></td>
	...
	<tr valign="top">
		...
		<td class="value"><input type="text" name="subject" id="subject" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['subject'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="60" maxlength="255" class="textField" /></td>
	</tr>
	<tr valign="top"><td colspan="2">&nbsp;</td></tr>
	<tr valign="top">
...
<table width="100%" class="data">
	<tr valign="top">
		...
		<td class="value"><input type="file" name="uploadSuppFile" id="uploadSuppFile" class="uploadField" />&nbsp;&nbsp;<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "form.saveToUpload"), $this);?>
</td>
	</tr>
	<?php if (! $this->_tpl_vars['suppFile']): ?>
	<tr valign="top">
