...
smarty_core_load_plugins(array('plugins' => array(array('block', 'iterate', 'gateway/lockss.tpl', 20, false),array('modifier', 'escape', 'gateway/lockss.tpl', 21, false),array('modifier', 'nl2br', 'gateway/lockss.tpl', 101, false),array('function', 'mailto', 'gateway/lockss.tpl', 96, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'journals','item' => 'journal')); $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true);while ($_block_repeat) { ob_start(); ?>
	<?php if ($this->_tpl_vars['journal']->getSetting('enableLockss')): ?><li><a href="<?php echo $this->_tpl_vars['indexUrl']; ?>
/<?php echo $this->_tpl_vars['journal']->getPath(); ?>
/gateway/lockss"><?php echo ((is_array($_tmp=$this->_tpl_vars['journal']->getTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a></li><?php endif;  $_block_content = ob_get_contents(); ob_end_clean(); echo $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat=false); }  array_pop($this->_tag_stack); ?>
</ul>
<?php else: ?>

<p><?php if ($this->_tpl_vars['prevYear'] !== null): ?><a href="<?php echo $this->_tpl_vars['requestPageUrl']; ?>
/lockss?year=<?php echo $this->_tpl_vars['prevYear']; ?>
" class="action">&lt;&lt; Previous</a><?php else: ?><span class="disabled heading">&lt;&lt; Previous</span><?php endif; ?> | <?php if ($this->_tpl_vars['nextYear'] !== null): ?><a href="<?php echo $this->_tpl_vars['requestPageUrl']; ?>
/lockss?year=<?php echo $this->_tpl_vars['nextYear']; ?>
...
<ul>
	<li><a href="<?php echo $this->_tpl_vars['pageUrl']; ?>
/about">About the Journal</a></li>
	<li><a href="<?php echo $this->_tpl_vars['pageUrl']; ?>
/about/submissions">Submission Guidelines</a></li>
	<li><a href="<?php echo $this->_tpl_vars['pageUrl']; ?>
/about/contact">Contact Information</a></li>
</ul>
