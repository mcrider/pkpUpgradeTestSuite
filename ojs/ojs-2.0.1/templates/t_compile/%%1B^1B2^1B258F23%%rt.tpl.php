...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'rt/rt.tpl', 40, false),array('modifier', 'truncate', 'rt/rt.tpl', 44, false),)), $this); ?>
...
<h6><?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getArticleTitle())) ? $this->_run_mod_handler('truncate', true, $_tmp, 20) : smarty_modifier_truncate($_tmp, 20)); ?>
</h6>
...
" target="_parent" class="rtAction"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.close"), $this);?>
	...
	<?php elseif ($this->_tpl_vars['galley']->isPdfGalley()): ?>
		<a href="<?php echo $this->_tpl_vars['requestPageUrl']; ?>
/viewPDFInterstitial/<?php echo $this->_tpl_vars['articleId']; ?>
/<?php echo $this->_tpl_vars['galleyId']; ?>
" target="_parent" class="rtAction"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.close"), $this);?>
</a>
	<?php else: ?>
		<a href="<?php echo $this->_tpl_vars['requestPageUrl']; ?>
/viewDownloadInterstitial/<?php echo $this->_tpl_vars['articleId']; ?>
/<?php echo $this->_tpl_vars['galleyId']; ?>
" target="_parent" class="rtAction"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.close"), $this);?>
</a>
	<?php endif;  endif; ?>
