...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'layoutEditor/submission/layout.tpl', 13, false),array('function', 'url', 'layoutEditor/submission/layout.tpl', 29, false),array('function', 'icon', 'layoutEditor/submission/layout.tpl', 42, false),array('modifier', 'to_array', 'layoutEditor/submission/layout.tpl', 29, false),array('modifier', 'escape', 'layoutEditor/submission/layout.tpl', 29, false),array('modifier', 'date_format', 'layoutEditor/submission/layout.tpl', 29, false),array('modifier', 'default', 'layoutEditor/submission/layout.tpl', 35, false),array('modifier', 'assign', 'layoutEditor/submission/layout.tpl', 44, false),)), $this); ?>
...
')" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.delete"), $this);?>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="5">
			<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'uploadGalley'), $this);?>
...
')" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.delete"), $this);?>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="5">
			<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'uploadSuppFile'), $this);?>
" enctype="multipart/form-data">
