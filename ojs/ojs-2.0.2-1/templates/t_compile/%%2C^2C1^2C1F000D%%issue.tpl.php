...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'issue/issue.tpl', 13, false),array('function', 'translate', 'issue/issue.tpl', 20, false),)), $this); ?>
...
<table width="100%">
<tr valign="top">
	<td width="75%"><?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getArticleTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
