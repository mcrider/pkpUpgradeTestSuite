...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'editor/issues/issueToc.tpl', 13, false),array('modifier', 'truncate', 'editor/issues/issueToc.tpl', 78, false),array('function', 'translate', 'editor/issues/issueToc.tpl', 22, false),array('function', 'html_options', 'editor/issues/issueToc.tpl', 32, false),)), $this); ?>
...
" class="action"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['article']->getArticleTitle())) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : smarty_modifier_truncate($_tmp, 60, "...")))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a></td>
