...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_unsafe_html', 'rt/bio.tpl', 16, false),array('modifier', 'escape', 'rt/bio.tpl', 20, false),array('modifier', 'nl2br', 'rt/bio.tpl', 26, false),)), $this); ?>

<?php $this->assign('pageTitle', "rt.authorBio"); ?>
...
<p>
	...
	<?php if ($this->_tpl_vars['author']->getUrl()): ?><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['author']->getUrl())) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
