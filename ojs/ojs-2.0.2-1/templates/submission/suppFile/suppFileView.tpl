 ...
 *
 * $Id: suppFileView.tpl,v 1.7 2005/08/03 19:40:31 alec Exp $
 *}
...
{if $suppFile}
	<tr valign="top">
		...
		<td width="80%" class="value"><a href="{$requestPageUrl}/downloadFile/{$articleId}/{$suppFile->getFileId()}">{$suppFile->getFileName()|escape}</a></td>
	</tr>
	<tr valign="top">
