<?php return array (
  ...
  'plugins.generic.translator.errors.LOCALE_ERROR_SUSPICIOUS_LENGTH.title' => 'Suspicious Key Lengths',
  ...
  'plugins.generic.translator.errors.LOCALE_ERROR_SUSPICIOUS_LENGTH.message' => 'The locale key "{$key}" in "{$filename}" has a considerably different length than the reference:<ul>
		<li>{$value} ({$locale})</li>
		<li>{$reference} ({$referenceLocale})</li>
	</ul>',
