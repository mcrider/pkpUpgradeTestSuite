...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submissionEmailLogEntry.tpl', 17, false),array('function', 'icon', 'sectionEditor/submissionEmailLogEntry.tpl', 55, false),array('modifier', 'date_format', 'sectionEditor/submissionEmailLogEntry.tpl', 41, false),array('modifier', 'escape', 'sectionEditor/submissionEmailLogEntry.tpl', 51, false),array('modifier', 'nl2br', 'sectionEditor/submissionEmailLogEntry.tpl', 83, false),)), $this); ?>
...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<?php $this->assign('subjectEscaped', ((is_array($_tmp=$this->_tpl_vars['logEntry']->getSubject())) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url'))); ?>
			<?php if ($this->_tpl_vars['logEntry']->getSenderFullName()): ?>
				<?php echo $this->_tpl_vars['logEntry']->getSenderFullName(); ?>
