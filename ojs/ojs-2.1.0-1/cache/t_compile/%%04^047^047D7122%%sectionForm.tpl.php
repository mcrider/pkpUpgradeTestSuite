...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/sections/sectionForm.tpl', 14, false),array('function', 'translate', 'manager/sections/sectionForm.tpl', 63, false),array('function', 'fieldLabel', 'manager/sections/sectionForm.tpl', 105, false),array('modifier', 'assign', 'manager/sections/sectionForm.tpl', 14, false),array('modifier', 'escape', 'manager/sections/sectionForm.tpl', 63, false),)), $this); ?>

<?php $this->assign('pageTitle', "section.section");  $this->assign('pageCrumbTitle', "section.sections");  echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'sections'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'currentUser') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'currentUser'));?>
...
<form name="section" method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'updateSection'), $this);?>
" onsubmit="return saveSelectedEditors()">
...
<tr valign="top">
	<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'titleAlt1','key' => "section.title"), $this);?>
...
" id="titleAlt1" size="40" maxlength="120" class="textField" /></td>
</tr>
<?php endif;  if ($this->_tpl_vars['alternateLocale2']): ?>
<tr valign="top">
	<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'titleAlt2','key' => "section.title"), $this);?>
...
" id="titleAlt2" size="40" maxlength="120" class="textField" /></td>
</tr>
<?php endif; ?>
<tr valign="top">
...
<?php if ($this->_tpl_vars['alternateLocale1']): ?>
<tr valign="top">
	<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'abbrevAlt1','required' => 'true','key' => "section.abbreviation"), $this);?>
&nbsp;(<?php echo ((is_array($_tmp=$this->_tpl_vars['languageToggleLocales'][$this->_tpl_vars['alternateLocale1']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)</td>
	<td class="value"><input type="text" name="abbrevAlt1" id="abbrevAlt1" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['abbrevAlt1'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="20" maxlength="20" class="textField" /></td>
</tr>
<?php endif;  if ($this->_tpl_vars['alternateLocale2']): ?>
<tr valign="top">
	<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'abbrevAlt2','required' => 'true','key' => "section.abbreviation"), $this);?>
&nbsp;(<?php echo ((is_array($_tmp=$this->_tpl_vars['languageToggleLocales'][$this->_tpl_vars['alternateLocale2']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)</td>
	<td class="value"><input type="text" name="abbrevAlt2" id="abbrevAlt2" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['abbrevAlt2'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="20" maxlength="20" class="textField" /></td>
</tr>
<?php endif; ?>
<tr valign="top">
