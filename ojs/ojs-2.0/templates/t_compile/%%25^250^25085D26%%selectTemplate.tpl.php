...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'manager/people/selectTemplate.tpl', 29, false),array('function', 'translate', 'manager/people/selectTemplate.tpl', 42, false),)), $this); ?>
...
/manager/selectTemplate" method="post">
...
<tr><td colspan="5" class="headseparator">&nbsp;</td></tr>
<form action="<?php echo $this->_tpl_vars['pageUrl']; ?>
/manager/email" name="submit" method="post">
