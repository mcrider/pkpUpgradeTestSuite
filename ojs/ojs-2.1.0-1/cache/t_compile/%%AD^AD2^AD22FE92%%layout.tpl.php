<?php /* Smarty version 2.6.12, created on 2006-02-03 13:26:35
         compiled from copyeditor/submission/layout.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'copyeditor/submission/layout.tpl', 15, false),array('function', 'url', 'copyeditor/submission/layout.tpl', 32, false),array('function', 'icon', 'copyeditor/submission/layout.tpl', 66, false),array('modifier', 'escape', 'copyeditor/submission/layout.tpl', 20, false),array('modifier', 'to_array', 'copyeditor/submission/layout.tpl', 32, false),array('modifier', 'date_format', 'copyeditor/submission/layout.tpl', 33, false),)), $this); ?>
...
:
&nbsp; <?php if ($this->_tpl_vars['layoutAssignment']->getEditorId()):  echo ((is_array($_tmp=$this->_tpl_vars['layoutAssignment']->getEditorFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  else:  echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.none"), $this); endif; ?>
</p>
<?php endif; ?>
