...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submit/step4.tpl', 19, false),array('function', 'fieldLabel', 'author/submit/step4.tpl', 54, false),array('modifier', 'date_format', 'author/submit/step4.tpl', 40, false),array('modifier', 'escape', 'author/submit/step4.tpl', 41, false),)), $this); ?>
...
<tr class="heading" valign="bottom">
	...
	<td width="15%"><nobr><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.dateUploaded"), $this);?>
</nobr></td>
...
<tr valign="top">
	...
	<td><?php echo $this->_tpl_vars['file']->getTitle(); ?>
</td>
	<td><?php echo $this->_tpl_vars['file']->getOriginalFileName(); ?>
</td>
