...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/active.tpl', 15, false),array('function', 'page_info', 'author/active.tpl', 66, false),array('function', 'page_links', 'author/active.tpl', 67, false),array('block', 'iterate', 'author/active.tpl', 24, false),array('modifier', 'date_format', 'author/active.tpl', 30, false),array('modifier', 'escape', 'author/active.tpl', 31, false),array('modifier', 'truncate', 'author/active.tpl', 32, false),)), $this); ?>
...
" class="action"><?php if ($this->_tpl_vars['submission']->getArticleTitle()):  echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getArticleTitle())) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : smarty_modifier_truncate($_tmp, 60, "...")))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  else:  echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.untitled"), $this); endif; ?></a></td>
			<td align="right">
				...
				<?php elseif ($this->_tpl_vars['status'] == STATUS_QUEUED_EDITING): ?><a href="<?php echo $this->_tpl_vars['requestPageUrl']; ?>
...
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submissions.queuedEditing"), $this);?>
				...
				<?php elseif ($this->_tpl_vars['status'] == STATUS_QUEUED_REVIEW): ?><a href="<?php echo $this->_tpl_vars['requestPageUrl']; ?>
/submissionReview/<?php echo $this->_tpl_vars['articleId']; ?>
...
/author/submit/<?php echo $this->_tpl_vars['progress']; ?>
...
<br /><a href="<?php echo $this->_tpl_vars['pageUrl']; ?>
/author/deleteSubmission/<?php echo $this->_tpl_vars['articleId']; ?>
