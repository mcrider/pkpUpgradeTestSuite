<?php /* Smarty version 2.6.9, created on 2005-07-08 06:02:01
         compiled from manager/subscription/subscriptionTypeForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/subscription/subscriptionTypeForm.tpl', 24, false),array('function', 'fieldLabel', 'manager/subscription/subscriptionTypeForm.tpl', 37, false),array('function', 'html_options', 'manager/subscription/subscriptionTypeForm.tpl', 54, false),array('modifier', 'escape', 'manager/subscription/subscriptionTypeForm.tpl', 38, false),)), $this); ?>
...
/manager/updateSubscriptionType">
<?php if ($this->_tpl_vars['typeId']): ?>
...
<tr valign="top">
	...
	<td class="value"><textarea name="description" id="description" cols="40" rows="2" class="textArea" /><?php echo ((is_array($_tmp=$this->_tpl_vars['description'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></td>
</tr>
<tr valign="top">
...
<tr valign="top">
	<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'seq','required' => 'true','key' => "manager.subscriptionTypes.form.seq"), $this);?>
</td>
	<td class="value">
		<input type="text" name="seq" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['seq'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="5" maxlength="10" id="seq" class="textField" />
		<br />
		<span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.subscriptionTypes.form.seqInstructions"), $this);?>
</span>
	</td>
</tr>
</table>
