...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submission/layout.tpl', 15, false),array('function', 'url', 'sectionEditor/submission/layout.tpl', 22, false),array('function', 'icon', 'sectionEditor/submission/layout.tpl', 50, false),array('modifier', 'escape', 'sectionEditor/submission/layout.tpl', 21, false),array('modifier', 'to_array', 'sectionEditor/submission/layout.tpl', 38, false),array('modifier', 'date_format', 'sectionEditor/submission/layout.tpl', 38, false),array('modifier', 'assign', 'sectionEditor/submission/layout.tpl', 47, false),array('modifier', 'default', 'sectionEditor/submission/layout.tpl', 57, false),)), $this); ?>
...
<table class="data" width="100%">
	<tr>
		...
		<?php if ($this->_tpl_vars['layoutAssignment']->getEditorId()): ?><td width="20%" class="value"><?php echo ((is_array($_tmp=$this->_tpl_vars['layoutAssignment']->getEditorFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td><?php endif; ?>
		<td class="value"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'assignLayoutEditor','path' => $this->_tpl_vars['submission']->getArticleId()), $this);?>
