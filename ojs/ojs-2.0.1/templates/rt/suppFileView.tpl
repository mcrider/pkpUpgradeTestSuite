 ...
 *
 * $Id: suppFileView.tpl,v 1.2 2005/04/25 07:34:01 kevin Exp $
 *}
...
{if $suppFile}
	<tr valign="top">
		...
		<td width="80%" class="value"><a href="{$pageUrl}/article/download/{$articleId}/{$suppFile->getFileId()}">{$suppFile->getFileName()}</a></td>
	</tr>
	<tr valign="top">
