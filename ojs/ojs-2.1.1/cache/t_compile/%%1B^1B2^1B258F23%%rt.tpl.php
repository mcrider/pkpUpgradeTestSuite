...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'rt/rt.tpl', 19, false),array('modifier', 'to_array', 'rt/rt.tpl', 38, false),array('modifier', 'strip_unsafe_html', 'rt/rt.tpl', 44, false),array('modifier', 'truncate', 'rt/rt.tpl', 44, false),array('modifier', 'assign', 'rt/rt.tpl', 148, false),array('function', 'url', 'rt/rt.tpl', 38, false),array('function', 'translate', 'rt/rt.tpl', 38, false),array('function', 'html_options_translate', 'rt/rt.tpl', 123, false),)), $this); ?>
...
<p><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'issue','op' => 'view','path' => ((is_array($_tmp=$this->_tpl_vars['issue']->getBestIssueId($this->_tpl_vars['journal']))) ? $this->_run_mod_handler('to_array', true, $_tmp, 'showToc') : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, 'showToc'))), $this);?>
...
<h6><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['article']->getArticleTitle())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...", true) : smarty_modifier_truncate($_tmp, 20, "...", true)); ?>
</h6>
...
<?php if ($this->_tpl_vars['journalRt']->getEnabled()): ?>
<div class="rtBlock">
	<ul>
		<?php if ($this->_tpl_vars['journalRt']->getAbstract() && $this->_tpl_vars['galley'] && ! $this->_tpl_vars['section']->getAbstractsDisabled()): ?><li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => $this->_tpl_vars['articleId']), $this);?>
...
');<?php else:  echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'download','path' => ((is_array($_tmp=$this->_tpl_vars['articleId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['galley']->getFileId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['galley']->getFileId()))), $this); endif; ?>"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "rt.printVersion"), $this);?>
		...
		<?php if ($this->_tpl_vars['journalRt']->getDefineTerms() && $this->_tpl_vars['version']): ?>
...
" target="_parent" class="rtAction"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.close"), $this);?>
	...
	<?php endif;  else: ?>
	<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'viewArticle','path' => $this->_tpl_vars['articleId']), $this);?>
" target="_parent" class="rtAction"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.close"), $this);?>
</a>
<?php endif; ?>
