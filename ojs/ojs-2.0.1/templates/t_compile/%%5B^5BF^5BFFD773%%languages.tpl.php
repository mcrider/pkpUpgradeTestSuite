...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'admin/languages.tpl', 17, false),array('modifier', 'escape', 'admin/languages.tpl', 74, false),)), $this); ?>
...
"<?php if ($this->_tpl_vars['localeKey'] == $this->_tpl_vars['primaryLocale']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['localeNames'][$this->_tpl_vars['localeKey']]; ?>
</option>
...
]"><?php echo $this->_tpl_vars['localeNames'][$this->_tpl_vars['localeKey']]; ?>
</label></td>
		</tr>
		<?php endforeach; endif; unset($_from); ?>
		</table>
...
?>
<tr valign="top">
	<td width="20%"><li><?php echo $this->_tpl_vars['localeNames'][$this->_tpl_vars['localeKey']]; ?>
