...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'reviewer/completed.tpl', 15, false),array('function', 'print_issue_id', 'reviewer/completed.tpl', 76, false),array('function', 'page_info', 'reviewer/completed.tpl', 97, false),array('function', 'page_links', 'reviewer/completed.tpl', 98, false),array('block', 'iterate', 'reviewer/completed.tpl', 25, false),array('modifier', 'date_format', 'reviewer/completed.tpl', 31, false),array('modifier', 'escape', 'reviewer/completed.tpl', 32, false),array('modifier', 'truncate', 'reviewer/completed.tpl', 33, false),array('modifier', 'default', 'reviewer/completed.tpl', 62, false),)), $this); ?>
...
" class="action"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getArticleTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : smarty_modifier_truncate($_tmp, 60, "...")); ?>
</a></td>
		<td>
...
?>
		...
		<td>
			...
			<?php elseif ($this->_tpl_vars['submission']->getCancelled()): ?>
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.cancelled"), $this);?>

			<?php else: ?>
				<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getDateCompleted())) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatTrunc']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatTrunc'])))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
		...
		<td>
			...
			<?php elseif ($this->_tpl_vars['status'] == STATUS_ARCHIVED): ?>
