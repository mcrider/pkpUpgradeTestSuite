...
/**
 * @defgroup submission_copyAssignment
 */
 
/**
 * @file classes/submission/copyAssignment/CopyAssignment.inc.php
 *
 * Copyright (c) 2003-2009 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class CopyAssignment
 * @ingroup submission_copyAssignment
 * @see CopyAssignmentDAO
 *
 * @brief Describes copyediting assignments.
 */

// $Id: CopyAssignment.inc.php,v 1.9.2.1 2009/04/08 19:42:49 asmecher Exp $
