...
?>
		...
		<td><?php $this->assign('editAssignment', $this->_tpl_vars['submission']->getEditor());  echo ((is_array($_tmp=$this->_tpl_vars['editAssignment']->getEditorInitials())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
	</tr>
	<tr>
