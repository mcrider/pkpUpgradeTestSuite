...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'about/subscriptions.tpl', 15, false),array('function', 'mailto', 'about/subscriptions.tpl', 30, false),array('modifier', 'escape', 'about/subscriptions.tpl', 18, false),array('modifier', 'nl2br', 'about/subscriptions.tpl', 21, false),array('modifier', 'string_format', 'about/subscriptions.tpl', 58, false),array('block', 'iterate', 'about/subscriptions.tpl', 52, false),)), $this); ?>

<?php $this->assign('pageTitle', "about.subscriptions");  $_smarty_tpl_vars = $this->_tpl_vars;
...
<p>
	<?php if (! empty ( $this->_tpl_vars['subscriptionName'] )): ?>
		<strong><?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</strong><br />
	<?php endif; ?>
	<?php if (! empty ( $this->_tpl_vars['subscriptionMailingAddress'] )): ?>
		<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['subscriptionMailingAddress'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
<br />
	<?php endif; ?>
...
: <?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionPhone'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br />
	<?php endif; ?>
...
: <?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionFax'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br />
	<?php endif; ?>
...
: <?php echo smarty_function_mailto(array('address' => ((is_array($_tmp=$this->_tpl_vars['subscriptionEmail'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)),'encode' => 'hex'), $this);?>
<br /><br />
	<?php endif; ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'subscriptionTypes','item' => 'subscriptionType')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php if ($this->_tpl_vars['subscriptionType']->getPublic()): ?>
		<tr valign="top">
...
<br /><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getDescription())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</td>
			...
			<td><?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getDurationYearsMonths())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
...
&nbsp;(<?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getCurrencyStringShort())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)</td>
		</tr>
		<tr><td colspan="4" class="<?php if ($this->_tpl_vars['subscriptionTypes']->eof()): ?>end<?php endif; ?>separator">&nbsp;</td></tr>
	<?php endif;  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
</table>
</p>
