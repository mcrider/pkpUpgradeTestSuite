...
Test Journal
http://localhost/dev/pkpUpgradeTests/ojs/ojs-2.2/index.php/tj',
  'fastTrackFee' => 0,
  'itemsPerPage' => 25,
  'membershipFee' => 0,
  'numPageLinks' => 10,
  ...
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="http://localhost/dev/pkpUpgradeTests/ojs/ojs-2.2/index.php/tj/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="http://localhost/dev/pkpUpgradeTests/ojs/ojs-2.2/index.php/tj/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="http://localhost/dev/pkpUpgradeTests/ojs/ojs-2.2/index.php/tj/user/register">register</a> with the journal prior to submitting, or if already registered can simply <a href="http://localhost/dev/pkpUpgradeTests/ojs/ojs-2.2/index.php/index/login">log in</a> and begin the 5 step process.',
  ),
  ...
  array (
    'en_US' => 'The copyediting stage is intended to improve the flow, clarity, grammar, wording, and formatting of the article. It represents the last chance for the author to make any substantial changes to the text, as the next stage is restricted to typos and formatting corrections. 
...
&bull; Comment contains a reply to the editors\' QA',
  ...
  'lockssLicense' => 
  array (
    'en_US' => 'This journal utilizes the LOCKSS system to create a distributed archiving system among participating libraries and permits those libraries to create permanent archives of the journal for purposes of preservation and restoration. <a href="http://lockss.stanford.edu/">More...</a>',
  ),
...
The paragraph that begins "This last topic..." is not indented.</pre>',
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="http://localhost/dev/pkpUpgradeTests/ojs/ojs-2.2/index.php/tj/user/register">Register</a> link at the top of the homepage for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="http://localhost/dev/pkpUpgradeTests/ojs/ojs-2.2/index.php/tj/about/submissions#privacyStatement">Privacy Statement</a> which assures readers that their name and email address will not be used for other purposes.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  array (
    ...
    array (
      ...
      1 => 
      array (
        'content' => 'The submission file is in Microsoft Word, RTF, or WordPerfect document file format.',
        'order' => '2',
      ),
      2 => 
      array (
      ...
      4 => 
      array (
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="http://localhost/dev/pkpUpgradeTests/ojs/ojs-2.2/index.php/tj/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://localhost/dev/pkpUpgradeTests/ojs/ojs-2.2/index.php/tj/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a>) have been followed.',
        'order' => '6',
      ),
    ),
  ),
