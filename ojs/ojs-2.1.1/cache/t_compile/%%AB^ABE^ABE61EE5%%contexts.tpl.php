...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'rtadmin/contexts.tpl', 16, false),array('function', 'translate', 'rtadmin/contexts.tpl', 16, false),array('function', 'page_info', 'rtadmin/contexts.tpl', 45, false),array('function', 'page_links', 'rtadmin/contexts.tpl', 46, false),array('block', 'iterate', 'rtadmin/contexts.tpl', 30, false),array('modifier', 'escape', 'rtadmin/contexts.tpl', 32, false),array('modifier', 'to_array', 'rtadmin/contexts.tpl', 34, false),)), $this); ?>
...
<table class="listing" width="100%">
	...
	<?php $this->_tag_stack[] = array('iterate', array('from' => 'contexts','item' => 'context')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<tr valign="top">
			<td><?php echo ((is_array($_tmp=$this->_tpl_vars['context']->getTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
			<td><?php echo ((is_array($_tmp=$this->_tpl_vars['context']->getAbbrev())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
			<td align="right"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'moveContext','path' => ((is_array($_tmp=$this->_tpl_vars['version']->getVersionId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['context']->getContextId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['context']->getContextId())),'dir' => 'u'), $this);?>
" class="action">&uarr;</a>&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'moveContext','path' => ((is_array($_tmp=$this->_tpl_vars['version']->getVersionId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['context']->getContextId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['context']->getContextId())),'dir' => 'd'), $this);?>
