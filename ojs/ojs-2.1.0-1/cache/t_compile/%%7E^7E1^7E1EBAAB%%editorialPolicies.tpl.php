...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'about/editorialPolicies.tpl', 20, false),array('function', 'translate', 'about/editorialPolicies.tpl', 20, false),array('function', 'icon', 'about/editorialPolicies.tpl', 63, false),array('modifier', 'escape', 'about/editorialPolicies.tpl', 28, false),array('modifier', 'nl2br', 'about/editorialPolicies.tpl', 35, false),)), $this); ?>
...
<ul class="plain">
	<?php if (! empty ( $this->_tpl_vars['journalSettings']['focusScopeDesc'] )): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'editorialPolicies','anchor' => 'focusAndScope'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.focusAndScope"), $this);?>
</a></li><?php endif; ?>
	<li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'editorialPolicies','anchor' => 'sectionPolicies'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.sectionPolicies"), $this);?>
</a></li>
	<?php if (! empty ( $this->_tpl_vars['journalSettings']['reviewPolicy'] )): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'editorialPolicies','anchor' => 'peerReviewProcess'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.peerReviewProcess"), $this);?>
</a></li><?php endif; ?>
	<?php if (! empty ( $this->_tpl_vars['journalSettings']['pubFreqPolicy'] )): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'editorialPolicies','anchor' => 'publicationFrequency'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.publicationFrequency"), $this);?>
</a></li><?php endif; ?>
	<?php if (! empty ( $this->_tpl_vars['journalSettings']['openAccessPolicy'] )): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'editorialPolicies','anchor' => 'openAccessPolicy'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.openAccessPolicy"), $this);?>
</a></li><?php endif; ?>
	<?php if ($this->_tpl_vars['journalSettings']['enableLockss'] && ! empty ( $this->_tpl_vars['journalSettings']['lockssLicense'] )): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'editorialPolicies','anchor' => 'archiving'), $this);?>
...
?>
		<?php if (! empty ( $this->_tpl_vars['customAboutItem']['title'] )): ?>
			<li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'editorialPolicies','anchor' => "custom".($this->_tpl_vars['key'])), $this);?>
...
?>
 ...
 <?php echo ((is_array($_tmp=$this->_tpl_vars['sectionEditor']->getLastName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  if (strlen ( $this->_tpl_vars['sectionEditor']->getAffiliation() ) > 0): ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['sectionEditor']->getAffiliation())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  endif; ?></li>
	...
	<table class="plain" width="60%">
		<tr>
			<td width="50%"><?php if (! $this->_tpl_vars['section']->getEditorRestricted()):  echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'checked'), $this); else:  echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'unchecked'), $this); endif; ?> <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.sections.open"), $this);?>
</td>
			<td width="50%"><?php if ($this->_tpl_vars['section']->getMetaIndexed()):  echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'checked'), $this); else:  echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'unchecked'), $this); endif; ?> <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.sections.indexed"), $this);?>
</td>
		</tr>
	</table>
<?php endforeach; endif; unset($_from); ?>
