...
" size="60" maxlength="255" class="textField" />
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<input type="checkbox" name="options[]" id="options-redirect" value="redirect"<?php if ($this->_tpl_vars['options'] && in_array ( 'redirect' , $this->_tpl_vars['options'] )): ?> checked="checked"<?php endif; ?> /> <label for="options-redirect"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "admin.journals.redirect"), $this);?>
</label>
		</td>
	</tr>
</table>
