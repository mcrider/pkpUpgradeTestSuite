...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/groups/selectUser.tpl', 15, false),array('function', 'html_options_translate', 'manager/groups/selectUser.tpl', 17, false),array('function', 'translate', 'manager/groups/selectUser.tpl', 20, false),array('function', 'page_info', 'manager/groups/selectUser.tpl', 52, false),array('function', 'page_links', 'manager/groups/selectUser.tpl', 53, false),array('modifier', 'escape', 'manager/groups/selectUser.tpl', 23, false),array('modifier', 'to_array', 'manager/groups/selectUser.tpl', 40, false),array('block', 'iterate', 'manager/groups/selectUser.tpl', 35, false),)), $this); ?>

<?php $this->assign('pageTitle', "manager.groups.membership.addMember"); ?>
...
?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => $this->_tpl_vars['group']->getGroupId(),'searchInitial' => $this->_tpl_vars['letter']), $this);?>
"><?php if ($this->_tpl_vars['letter'] == $this->_tpl_vars['searchInitial']): ?><strong><?php echo $this->_tpl_vars['letter']; ?>
</strong><?php else:  echo $this->_tpl_vars['letter'];  endif; ?></a> <?php endforeach; endif; unset($_from); ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'groupMembership','path' => $this->_tpl_vars['group']->getGroupId()), $this);?>
