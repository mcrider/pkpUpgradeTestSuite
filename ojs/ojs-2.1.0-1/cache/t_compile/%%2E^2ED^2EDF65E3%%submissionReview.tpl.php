...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submissionReview.tpl', 12, false),array('function', 'url', 'author/submissionReview.tpl', 17, false),array('modifier', 'assign', 'author/submissionReview.tpl', 12, false),)), $this); ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.summary"), $this);?>
	...
	<li class="current"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submissionReview','path' => $this->_tpl_vars['submission']->getArticleId()), $this);?>
