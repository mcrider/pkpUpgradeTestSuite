...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/setup/step1.tpl', 15, false),array('function', 'translate', 'manager/setup/step1.tpl', 18, false),array('function', 'fieldLabel', 'manager/setup/step1.tpl', 22, false),array('modifier', 'escape', 'manager/setup/step1.tpl', 23, false),)), $this); ?>
...
<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'saveSetup','path' => '1'), $this);?>
">
...
" size="8" maxlength="16" class="textField" /></td>
	...
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'journalAbbreviation','key' => "manager.setup.journalAbbreviation"), $this);?>
</td>
		<td width="80%" class="value"><input type="text" name="journalAbbreviation" id="journalAbbreviation" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['journalAbbreviation'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="40" maxlength="120" class="textField" /></td>
	</tr>
	<tr valign="top">
		...
		<td width="80%" class="value"><input type="text" name="printIssn" id="onlineIssn" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['printIssn'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="8" maxlength="16" class="textField" /></td>
	</tr>
	<tr valign="top">
		...
		<td width="80%" class="value">
			<input type="text" name="onlineIssn" id="onlineIssn" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['onlineIssn'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="8" maxlength="16" class="textField" />
	...
	<tr valign="top">
		...
		<td width="80%" class="value"><input type="text" name="doiPrefix" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['doiPrefix'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<br />&nbsp;</td></tr>
	<tr valign="top">
		...
		<td width="80%" class="value">
			<input type="text" name="envelopeSender" id="envelopeSender" size="40" maxlength="255" class="textField" <?php if (! $this->_tpl_vars['envelopeSenderEnabled']): ?>disabled="disabled" value=""<?php else: ?>value="<?php echo ((is_array($_tmp=$this->_tpl_vars['envelopeSender'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php endif; ?> />
