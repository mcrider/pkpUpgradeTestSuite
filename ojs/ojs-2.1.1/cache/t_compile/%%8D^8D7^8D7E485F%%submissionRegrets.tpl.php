...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submissionRegrets.tpl', 13, false),array('function', 'url', 'sectionEditor/submissionRegrets.tpl', 19, false),array('modifier', 'assign', 'sectionEditor/submissionRegrets.tpl', 13, false),array('modifier', 'escape', 'sectionEditor/submissionRegrets.tpl', 14, false),)), $this); ?>

<?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "sectionEditor.regrets.title",'articleId' => $this->_tpl_vars['submission']->getArticleId()), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'pageTitleTranslated') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'pageTitleTranslated'));?>
