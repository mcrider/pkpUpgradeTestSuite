...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submission/editorDecision.tpl', 13, false),array('function', 'url', 'sectionEditor/submission/editorDecision.tpl', 19, false),array('function', 'html_options_translate', 'sectionEditor/submission/editorDecision.tpl', 22, false),array('function', 'icon', 'sectionEditor/submission/editorDecision.tpl', 45, false),array('modifier', 'escape', 'sectionEditor/submission/editorDecision.tpl', 24, false),array('modifier', 'date_format', 'sectionEditor/submission/editorDecision.tpl', 35, false),array('modifier', 'assign', 'sectionEditor/submission/editorDecision.tpl', 44, false),array('modifier', 'to_array', 'sectionEditor/submission/editorDecision.tpl', 96, false),array('modifier', 'count', 'sectionEditor/submission/editorDecision.tpl', 106, false),)), $this); ?>
...
" <?php if (! $this->_tpl_vars['allowRecommendation']): ?>disabled="disabled"<?php endif; ?> class="button" />
			<?php if (! $this->_tpl_vars['allowRecommendation']): ?>&nbsp;&nbsp;<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.cannotRecord"), $this); endif; ?>
		</form>
	</td>
</tr>
<tr valign="top">
...
<input type="hidden" name="articleId" value="<?php echo $this->_tpl_vars['submission']->getArticleId(); ?>
" />
<?php $this->assign('authorFiles', $this->_tpl_vars['submission']->getAuthorFileRevisions($this->_tpl_vars['round']));  $this->assign('editorFiles', $this->_tpl_vars['submission']->getEditorFileRevisions($this->_tpl_vars['round'])); ?>

<?php $this->assign('authorRevisionExists', false);  $_from = $this->_tpl_vars['authorFiles']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['authorFile']):
?>
	<?php $this->assign('authorRevisionExists', true);  endforeach; endif; unset($_from); ?>

<?php $this->assign('editorRevisionExists', false);  $_from = $this->_tpl_vars['editorFiles']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['editorFile']):
?>
	<?php $this->assign('editorRevisionExists', true);  endforeach; endif; unset($_from); ?>
...
" class="button" />
	...
	<?php elseif ($this->_tpl_vars['lastDecision'] == SUBMISSION_EDITOR_DECISION_ACCEPT): ?>
		<tr valign="top">
			<td width="20%">&nbsp;</td>
			<td width="80%">
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.sendFileToCopyedit"), $this);?>
	...
	<?php if ($this->_tpl_vars['reviewFile']): ?>
		<tr valign="top">
			...
			<td width="50%" class="value">
				<?php if ($this->_tpl_vars['lastDecision'] == SUBMISSION_EDITOR_DECISION_ACCEPT || $this->_tpl_vars['lastDecision'] == SUBMISSION_EDITOR_DECISION_RESUBMIT): ?><input type="radio" name="editorDecisionFile" value="<?php echo $this->_tpl_vars['reviewFile']->getFileId(); ?>
,<?php echo $this->_tpl_vars['reviewFile']->getRevision(); ?>
" /> <?php endif; ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['reviewFile']->getFileId(), $this->_tpl_vars['reviewFile']->getRevision()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['reviewFile']->getFileId(), $this->_tpl_vars['reviewFile']->getRevision()))), $this);?>
...
" /> <?php endif; ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['authorFile']->getFileId(), $this->_tpl_vars['authorFile']->getRevision()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['authorFile']->getFileId(), $this->_tpl_vars['authorFile']->getRevision()))), $this);?>
...
" /> <?php endif; ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['editorFile']->getFileId(), $this->_tpl_vars['editorFile']->getRevision()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['editorFile']->getFileId(), $this->_tpl_vars['editorFile']->getRevision()))), $this);?>
...
&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'deleteArticleFile','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['editorFile']->getFileId(), $this->_tpl_vars['editorFile']->getRevision()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['editorFile']->getFileId(), $this->_tpl_vars['editorFile']->getRevision()))), $this);?>
