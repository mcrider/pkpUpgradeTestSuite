...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submission/peerReview.tpl', 13, false),array('function', 'url', 'author/submission/peerReview.tpl', 33, false),array('modifier', 'ord', 'author/submission/peerReview.tpl', 15, false),array('modifier', 'to_array', 'author/submission/peerReview.tpl', 33, false),array('modifier', 'escape', 'author/submission/peerReview.tpl', 33, false),array('modifier', 'date_format', 'author/submission/peerReview.tpl', 33, false),array('modifier', 'chr', 'author/submission/peerReview.tpl', 70, false),)), $this); ?>
...
?>
 ...
 <?php echo $this->_tpl_vars['thisReviewer']; ?>
					...
					<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['viewableFile']->getFileId(), $this->_tpl_vars['viewableFile']->getRevision()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['viewableFile']->getFileId(), $this->_tpl_vars['viewableFile']->getRevision()))), $this);?>
