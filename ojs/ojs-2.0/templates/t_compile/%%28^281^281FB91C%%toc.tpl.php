...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'help/toc.tpl', 14, false),)), $this); ?>
...
" class="textField" />&nbsp;<input type="submit" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.search"), $this);?>
" class="button" />
	</form>
</div>
...
/help/toc"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "help.toc"), $this);?>
</a></div>
...
/help/view/<?php echo $this->_tpl_vars['toc']->getParentTopicId(); ?>
...
/help/view/<?php echo $this->_tpl_vars['currTopic']->getId(); ?>
...
?>
				<li><a href="<?php echo $this->_tpl_vars['pageUrl']; ?>
/help/view/<?php echo $this->_tpl_vars['currSubTopic']->getId(); ?>
