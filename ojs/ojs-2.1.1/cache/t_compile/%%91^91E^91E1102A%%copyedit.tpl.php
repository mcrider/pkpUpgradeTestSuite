...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submission/copyedit.tpl', 13, false),array('function', 'url', 'author/submission/copyedit.tpl', 26, false),array('function', 'icon', 'author/submission/copyedit.tpl', 59, false),array('modifier', 'escape', 'author/submission/copyedit.tpl', 19, false),array('modifier', 'date_format', 'author/submission/copyedit.tpl', 34, false),array('modifier', 'default', 'author/submission/copyedit.tpl', 34, false),array('modifier', 'to_array', 'author/submission/copyedit.tpl', 43, false),array('modifier', 'assign', 'author/submission/copyedit.tpl', 61, false),)), $this); ?>
...
<table class="data" width="100%">
	<tr>
		...
		<td class="label" width="80%"><?php if ($this->_tpl_vars['submission']->getCopyeditorId()):  echo ((is_array($_tmp=$this->_tpl_vars['copyeditor']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  else:  echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.none"), $this); endif; ?></td>
	</tr>
</table>
<?php endif; ?>
