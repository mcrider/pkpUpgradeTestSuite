...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submission/management.tpl', 13, false),array('function', 'url', 'sectionEditor/submission/management.tpl', 22, false),array('function', 'icon', 'sectionEditor/submission/management.tpl', 23, false),array('function', 'html_options', 'sectionEditor/submission/management.tpl', 67, false),array('modifier', 'assign', 'sectionEditor/submission/management.tpl', 22, false),array('modifier', 'escape', 'sectionEditor/submission/management.tpl', 23, false),array('modifier', 'strip_unsafe_html', 'sectionEditor/submission/management.tpl', 28, false),array('modifier', 'to_array', 'sectionEditor/submission/management.tpl', 34, false),array('modifier', 'date_format', 'sectionEditor/submission/management.tpl', 34, false),array('modifier', 'strip_tags', 'sectionEditor/submission/management.tpl', 56, false),array('modifier', 'nl2br', 'sectionEditor/submission/management.tpl', 72, false),)), $this); ?>

<a name="submission"></a>
<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "article.submission"), $this);?>
</h3>

<?php $this->assign('submissionFile', $this->_tpl_vars['submission']->getSubmissionFile());  $this->assign('suppFiles', $this->_tpl_vars['submission']->getSuppFiles()); ?>
...
<table width="100%" class="data">
 ...
 <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => $this->_tpl_vars['url']), $this);?>
	...
	<tr>
		...
		<td colspan="2" class="value"><?php echo ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleTitle())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)); ?>
</td>
	</tr>
	<tr>
...
</a>&nbsp;&nbsp;&nbsp;&nbsp;<?php if (! $this->_tpl_vars['notFirst']): ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'addSuppFile','path' => $this->_tpl_vars['submission']->getArticleId()), $this);?>
...
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.addSuppFile"), $this);?>
 ...
 <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => $this->_tpl_vars['url']), $this);?>
	...
	<tr>
		...
		<td class="value"><form action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'updateSection','path' => $this->_tpl_vars['submission']->getArticleId()), $this);?>
