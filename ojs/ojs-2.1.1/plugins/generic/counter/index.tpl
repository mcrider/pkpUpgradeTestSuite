 ...
 *
 * $Id: index.tpl,v 1.1 2006/05/31 22:17:11 alec Exp $
 *}
...
<ul class="plain">
	...
	<li>&#187; <a href="{url op="clearLog"}" onclick="return confirm('{translate|escape:"javascript" key="plugins.generic.counter.confirmClear"}')">{translate key="plugins.generic.counter.clearLog"}</a></li>
