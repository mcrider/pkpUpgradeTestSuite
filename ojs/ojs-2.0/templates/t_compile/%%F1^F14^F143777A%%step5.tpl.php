...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/setup/step5.tpl', 18, false),array('function', 'fieldLabel', 'manager/setup/step5.tpl', 26, false),array('modifier', 'escape', 'manager/setup/step5.tpl', 27, false),array('modifier', 'date_format', 'manager/setup/step5.tpl', 36, false),)), $this); ?>
...
/manager/saveSetup/5" enctype="multipart/form-data">
...
<p><textarea name="journalDescription" wrap="virtual" rows="3" cols="60" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['journalDescription'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></p>
...
" size="60" maxlength="255" class="textField" />
	...
	<tr valign="top">
		...
		<td width="80%" class="value">
			<input type="text" name="navItems[<?php echo 0; ?>
][name]" id="navItems[<?php echo 0; ?>
][name]" size="30" maxlength="90" class="textField" />
			<table width="100%">
				<tr valign="top">
					<td width="5%"><input type="checkbox" name="navItems[<?php echo 0; ?>
][isLiteral]" id="navItems[<?php echo 0; ?>
][isLiteral]" value="1" /></td>
					<td width="95%"><label for="navItems[<?php echo 0; ?>
][isLiteral]"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.navItemIsLiteral"), $this);?>
</label></td>
				</tr>
			</table>
	...
	<tr valign="top">
		...
		<td width="80%" class="value">
			<input type="text" name="navItems[<?php echo 0; ?>
][url]" id="navItems[<?php echo 0; ?>
][url]" size="60" maxlength="255" class="textField" />
			<table width="100%">
				<tr valign="top">
					<td width="5%"><input type="checkbox" name="navItems[<?php echo 0; ?>
][isAbsolute]" id="navItems[<?php echo 0; ?>
][isAbsolute]" value="1" /></td>
					<td width="95%"><label for="navItems[<?php echo 0; ?>
][isAbsolute]"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.navItemIsAbsolute"), $this);?>
</label></td>
				</tr>
