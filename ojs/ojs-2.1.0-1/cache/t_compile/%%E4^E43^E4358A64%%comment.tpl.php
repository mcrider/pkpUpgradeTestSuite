...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'comment/comment.tpl', 29, false),array('modifier', 'to_array', 'comment/comment.tpl', 38, false),array('function', 'url', 'comment/comment.tpl', 38, false),array('function', 'translate', 'comment/comment.tpl', 41, false),)), $this); ?>
...
function handleAnonymousCheckbox(theBox) {
	if (theBox.checked) {
		...
		';  if ($this->_tpl_vars['isUserLoggedIn'] && ( $this->_tpl_vars['enableComments'] == COMMENTS_ANONYMOUS || $this->_tpl_vars['enableComments'] == COMMENTS_UNAUTHENTICATED )): ?>
...
<form name="submit" action="<?php if ($this->_tpl_vars['commentId']):  echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'edit','path' => ((is_array($_tmp=$this->_tpl_vars['articleId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['galleyId'], $this->_tpl_vars['commentId']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['galleyId'], $this->_tpl_vars['commentId']))), $this); else:  echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'add','path' => ((is_array($_tmp=$this->_tpl_vars['articleId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['galleyId'], $this->_tpl_vars['parentId'], 'save') : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['galleyId'], $this->_tpl_vars['parentId'], 'save'))), $this); endif; ?>" method="post">
...
" class="button" onclick="document.location.href='<?php echo $this->_tpl_vars['url']; ?>
" /></p>
