<?php /* Smarty version 2.6.26, created on 2010-08-12 15:43:42
...
<?php endif; ?></a> &gt;
	...
	<?php if (! PKPRequest ::isPost()): ?><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['currentUrl'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" class="current"><?php else: ?><span class="current"><?php endif; ?><?php echo $this->_tpl_vars['pageCrumbTitleTranslated']; ?>
<?php if (! PKPRequest ::isPost()): ?></a><?php else: ?></span><?php endif; ?>
</div>