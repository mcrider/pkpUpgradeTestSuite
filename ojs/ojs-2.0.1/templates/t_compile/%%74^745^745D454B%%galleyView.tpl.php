...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'submission/layout/galleyView.tpl', 15, false),array('modifier', 'date_format', 'submission/layout/galleyView.tpl', 57, false),)), $this); ?>
...
<tr valign="top">
	...
	<td width="80%" class="value"><?php echo $this->_tpl_vars['galley']->getLabel(); ?>
</td>
</tr>
...
<?php if ($this->_tpl_vars['styleFile']): ?>
	<tr valign="top>
		...
		<td class="value"><a href="<?php echo $this->_tpl_vars['requestPageUrl']; ?>
/downloadFile/<?php echo $this->_tpl_vars['articleId']; ?>
/<?php echo $this->_tpl_vars['styleFile']->getFileId(); ?>
" class="action"><?php echo $this->_tpl_vars['styleFile']->getFileName(); ?>
</a></td>
	</tr>
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.fileSize"), $this);?>
...
"><?php echo $this->_tpl_vars['imageFile']->getFileName(); ?>
</a></td>
	<td><?php echo $this->_tpl_vars['imageFile']->getOriginalFileName(); ?>
</td>
