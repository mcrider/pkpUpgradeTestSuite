...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/people/userProfileForm.tpl', 50, false),array('function', 'fieldLabel', 'manager/people/userProfileForm.tpl', 65, false),array('function', 'html_options_translate', 'manager/people/userProfileForm.tpl', 67, false),array('modifier', 'escape', 'manager/people/userProfileForm.tpl', 73, false),)), $this); ?>

<?php $this->assign('currentUrl', ($this->_tpl_vars['requestPageUrl'])."/people/all");  $this->assign('pageTitle', "manager.people");  $_smarty_tpl_vars = $this->_tpl_vars;
...
<form name="userForm" method="post" action="<?php echo $this->_tpl_vars['pageUrl']; ?>
/manager/updateUser" onsubmit="enablePasswordFields()">
