...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submission/status.tpl', 16, false),array('modifier', 'escape', 'sectionEditor/submission/status.tpl', 16, false),array('modifier', 'date_format', 'sectionEditor/submission/status.tpl', 55, false),)), $this); ?>
...
function confirmNotifyUnsuitable() {
	...
	if ($result) {
		document.location = "';  echo ((is_array($_tmp=$this->_tpl_vars['requestPageUrl'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'quote') : smarty_modifier_escape($_tmp, 'quote')); ?>
/unsuitableSubmission?articleId=<?php echo $this->_tpl_vars['submission']->getArticleId();  echo '"
	} else {
		document.location = "';  echo ((is_array($_tmp=$this->_tpl_vars['requestPageUrl'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'quote') : smarty_modifier_escape($_tmp, 'quote')); ?>
/archiveSubmission/<?php echo $this->_tpl_vars['submission']->getArticleId();  echo '";
	}
	return false;
}
// -->
