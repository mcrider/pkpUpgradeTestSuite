...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'common/sidebar.tpl', 13, false),array('function', 'get_help_id', 'common/sidebar.tpl', 17, false),array('function', 'html_options', 'common/sidebar.tpl', 66, false),array('function', 'html_options_translate', 'common/sidebar.tpl', 82, false),array('modifier', 'escape', 'common/sidebar.tpl', 24, false),)), $this); ?>
...
/index/user"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.myJournals"), $this);?>
</a></li>
		<?php endif; ?>
...
/user/setLocale/'+this.options[this.selectedIndex].value+'?source=<?php echo ((is_array($_tmp=$_SERVER['REQUEST_URI'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
