...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'submission/suppFile/suppFileView.tpl', 16, false),array('function', 'url', 'submission/suppFile/suppFileView.tpl', 71, false),array('modifier', 'escape', 'submission/suppFile/suppFileView.tpl', 21, false),array('modifier', 'default', 'submission/suppFile/suppFileView.tpl', 21, false),array('modifier', 'nl2br', 'submission/suppFile/suppFileView.tpl', 37, false),array('modifier', 'to_array', 'submission/suppFile/suppFileView.tpl', 71, false),array('modifier', 'date_format', 'submission/suppFile/suppFileView.tpl', 83, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['suppFile']): ?>
	<tr valign="top">
		...
		<td width="80%" class="value"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['articleId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['suppFile']->getFileId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['suppFile']->getFileId()))), $this);?>
