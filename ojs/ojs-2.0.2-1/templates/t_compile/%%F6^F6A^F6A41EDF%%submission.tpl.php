...
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign_translate', 'reviewer/submission.tpl', 14, false),array('function', 'translate', 'reviewer/submission.tpl', 24, false),array('function', 'icon', 'reviewer/submission.tpl', 56, false),array('function', 'html_options_translate', 'reviewer/submission.tpl', 267, false),array('modifier', 'escape', 'reviewer/submission.tpl', 24, false),array('modifier', 'strip_unsafe_html', 'reviewer/submission.tpl', 46, false),array('modifier', 'nl2br', 'reviewer/submission.tpl', 46, false),array('modifier', 'date_format', 'reviewer/submission.tpl', 68, false),)), $this); ?>
...
<tr valign="top">
	...
	<td width="80%" class="value"><?php echo ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
</tr>
<tr valign="top">
...
<tr valign="top">
	...
	<td class="value"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getArticleAbstract())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : $this->_plugins['modifier']['strip_unsafe_html'][0][0]->smartyStripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</td>
</tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => ($this->_tpl_vars['requestPageUrl'])."/confirmReview?reviewId=".($this->_tpl_vars['submission']->getReviewId())."&amp;declineReview=1"), $this);?>
			...
			<?php else: ?>
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.article.canDoReview"), $this);?>
 <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','disabled' => 'disabled','url' => ($this->_tpl_vars['requestPageUrl'])."/confirmReview?reviewId=".($this->_tpl_vars['submission']->getReviewId())), $this);?>

				&nbsp;&nbsp;&nbsp;&nbsp;
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.article.cannotDoReview"), $this);?>
 <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','disabled' => 'disabled','url' => ($this->_tpl_vars['requestPageUrl'])."/confirmReview?reviewId=".($this->_tpl_vars['submission']->getReviewId())."&amp;declineReview=1"), $this);?>
	...
	<td>
		<table class="data" width="100%">
			<tr valign="top">
				...
				<?php else: ?>
					<form name="recommendation" method="post" action="<?php echo $this->_tpl_vars['requestPageUrl']; ?>
