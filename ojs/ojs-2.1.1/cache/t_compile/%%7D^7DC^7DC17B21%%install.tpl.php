...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'install/install.tpl', 30, false),array('function', 'url', 'install/install.tpl', 37, false),array('function', 'fieldLabel', 'install/install.tpl', 64, false),array('function', 'html_options', 'install/install.tpl', 67, false),array('modifier', 'assign', 'install/install.tpl', 30, false),array('modifier', 'escape', 'install/install.tpl', 124, false),)), $this); ?>
...
<?php if (is_writeable ( 'config.inc.php' )):  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkYes"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_config') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_config')); else:  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkNo"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_config') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_config')); endif;  if (is_writeable ( 'cache' )):  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkYes"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_cache') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_cache')); else:  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkNo"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_cache') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_cache')); endif;  if (is_writeable ( 'public' )):  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkYes"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_public') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_public')); else:  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkNo"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_public') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_public')); endif;  if (is_writeable ( 'cache/_db' )):  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkYes"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_db_cache') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_db_cache')); else:  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkNo"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_db_cache') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_db_cache')); endif;  if (is_writeable ( 'cache/t_cache' )):  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkYes"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_templates_cache') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_templates_cache')); else:  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkNo"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_templates_cache') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_templates_cache')); endif;  if (is_writeable ( 'cache/t_compile' )):  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkYes"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_templates_compile') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_templates_compile')); else:  echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.checkNo"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'writable_templates_compile') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'writable_templates_compile')); endif; ?>
...
<p><input name="install" type="button" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.installOJS"), $this);?>
