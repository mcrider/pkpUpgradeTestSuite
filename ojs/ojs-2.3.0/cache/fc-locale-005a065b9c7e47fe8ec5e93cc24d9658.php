<?php return array (
  ...
  'plugin.generic.customBlockManager.introduction' => 'You can use this plugin to add or delete custom block plugins.  You can then edit the content through the <a href="{$systemPluginsUrl}">System Plugins</a> page (in the Blocks Plugin section).  To place your plugin in the desired location in the sidebar, go to <a href="{$setupStep56}">Step up 5.6</a>',
