...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'rt/captureCite.tpl', 16, false),array('modifier', 'count', 'rt/captureCite.tpl', 20, false),array('modifier', 'date_format', 'rt/captureCite.tpl', 26, false),array('modifier', 'trim', 'rt/captureCite.tpl', 36, false),array('function', 'translate', 'rt/captureCite.tpl', 23, false),)), $this); ?>
...
<ul>
	...
	<li><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "rt.captureCite.capture.endNote",'url' => ($this->_tpl_vars['requestPageUrl'])."/captureCite/".($this->_tpl_vars['escapedArticleId'])."/".($this->_tpl_vars['galleyId'])."/endNote"), $this);?>
</li>
	<li><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "rt.captureCite.capture.referenceManager",'url' => ($this->_tpl_vars['requestPageUrl'])."/captureCite/".($this->_tpl_vars['escapedArticleId'])."/".($this->_tpl_vars['galleyId'])."/referenceManager"), $this);?>
</li>
	<li><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "rt.captureCite.capture.proCite",'url' => ($this->_tpl_vars['requestPageUrl'])."/captureCite/".($this->_tpl_vars['escapedArticleId'])."/".($this->_tpl_vars['galleyId'])."/proCite"), $this);?>
</li>
</ul>
