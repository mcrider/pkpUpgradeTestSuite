 ...
 *
 * $Id: editorDecision.tpl,v 1.19 2005/05/30 18:46:46 alec Exp $
 *}
...
<tr valign="top">
	...
	<td width="80%" class="value" colspan="2">
		<form method="post" action="{$requestPageUrl}/recordDecision">
			...
			{if not $allowRecommendation}<br />{translate key="editor.article.cannotRecord}{/if}
		</form>
	</td>
</tr>
<tr valign="top">
