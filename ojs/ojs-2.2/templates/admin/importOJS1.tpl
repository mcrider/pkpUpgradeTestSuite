 ...
 *
 * $Id: importOJS1.tpl,v 1.8 2007/09/04 16:31:44 asmecher Exp $
 *}
...
<table class="data" width="100%">
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<input type="checkbox" name="options[]" id="options-transcode" value="transcode"{if $options && in_array('transcode', $options)} checked="checked"{/if} /> <label for="options-transcode">{translate key="admin.journals.transcode"}</label>
		</td>
	</tr>
</table>
