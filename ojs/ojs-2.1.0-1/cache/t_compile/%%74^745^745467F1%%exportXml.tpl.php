...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'rtadmin/exportXml.tpl', 7, false),)), $this); ?>
<?php echo '<?xml'; ?>
 version="1.0" encoding="UTF-8"<?php echo '?>'; ?>

<!DOCTYPE version SYSTEM "<?php echo $this->_tpl_vars['baseUrl']; ?>
/rt/rt-version.dtd">

<!--
  * <?php echo ((is_array($_tmp=$this->_tpl_vars['version']->getKey())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
.xml
  *
  * Reading Tools version: <?php echo ((is_array($_tmp=$this->_tpl_vars['version']->getTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 (<?php echo ((is_array($_tmp=$this->_tpl_vars['version']->getLocale())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)
  -->
...
<?php if ($this->_tpl_vars['context']->getAuthorTerms()): ?>		<author_terms /><?php endif;  if ($this->_tpl_vars['context']->getDefineTerms()): ?>		<define_terms /><?php endif;  if ($this->_tpl_vars['context']->getGeoTerms()): ?>		<geo_terms /><?php endif;  if ($this->_tpl_vars['context']->getCitedBy()): ?>		<cites_context /><?php endif; ?>
