...
form" <?php if ($this->_tpl_vars['search']->getSearchPost()): ?>method="post" <?php endif; ?>action="<?php echo ((is_array($_tmp=$this->_tpl_vars['search']->getSearchUrl())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));  if ($this->_tpl_vars['search']->urlNeedsKeywords): ?>KEYWORDS_HERE<?php endif; ?>">
